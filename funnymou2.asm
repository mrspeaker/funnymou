...
;;; ============================================================
;;;  Equates  (symbol table -- see CLAUDE.md for full docs)
;;; ============================================================

;;; --- hardware ---
    watchdog            = $B800 ; watchdog reset (read) / sound command write
    ...
    vram                = $9000 ; tilemap (32x32 of 8x8 tiles)
    spriteram           = $9840 ; 8 sprites x 4 bytes
...
;;; --- sprite mirror & actors ---
    ...
    bomb_supply         = $867F ; remaining bombs (=5 at each life start)
    bomb_lethal         = $8683 ; explosion active/lethal flag
;;; --- record fields (player) ---
    plr_input           = $8401 ; input bits (from in_joy / demo script)
    plr_frame           = $8402 ; frame counter (bit0 = half-rate gate)
    plr_facing          = $8404 ; facing direction (1/2/4/8)
    plr_yvel            = $8408 ; current Y velocity
    plr_xvel            = $8409 ; current X velocity
    plr_vel_d1          = $840B ; velocity constant, dir 1 (Y)
    plr_vel_d2          = $840D ; velocity constant, dir 2 (Y)
    plr_vel_d4          = $840F ; velocity constant, dir 4 (X)
    plr_vel_d8          = $8411 ; velocity constant, dir 8 (X)
    plr_color           = $8412 ; color -> sprite +2
    plr_tile            = $8413 ; final tile (orient|frame) -> sprite +1
    plr_orient          = $8414 ; orientation base
    plr_animframe       = $8415 ; anim frame (0-3)
    plr_moving          = $8416 ; moving flag (gates walk anim)
    plr_animsub         = $8417 ; anim sub-counter
    plr_animidx         = $8418 ; anim frame index
    plr_substate        = $8420 ; state substate flag
    plr_lock            = $8422 ; input-locked / cutscene flag
    plr_idle            = $8423 ; idle -> attract-demo countdown
    plr_death_step      = $8429 ; death-sequence step
    plr_death_fall      = $842A ; death-fall trigger
    plr_over_hole       = $842D ; over exit/hole flag (tile $F5)
;;; --- record fields (cat control $8500 / cats) ---
    catA_spawn          = $8501 ; catA spawned (enable = cat_ctrl_85)
    catB_en             = $8504 ; catB enable
    catB_spawn          = $8505 ; catB spawned
    catC_en             = $8506 ; catC enable
    catC_spawn          = $8507 ; catC spawned
    cat_init_a          = $8508 ; catA AI-path-initialised flag
    cat_init_b          = $850A ; catB AI-path-initialised flag
    cat_init_c          = $850B ; catC AI-path-initialised flag
    catA_state          = $8517 ; catA AI state (rec+$07)
    catA_wp_lo          = $8528 ; catA waypoint ptr lo (rec+$18)
    catA_wp_hi          = $8529 ; catA waypoint ptr hi (rec+$19)
    catA_busy           = $852B ; catA busy/collide lock (rec+$1B)
    catA_2ptr           = $852D ; catA secondary ptr lo (rec+$1D)
    catB_state          = $8557 ; catB AI state (rec+$07)
    catB_wp_lo          = $8568 ; catB waypoint ptr lo
    catB_wp_hi          = $8569 ; catB waypoint ptr hi
    catB_busy           = $856B ; catB busy lock
    catB_2ptr           = $856D ; catB secondary ptr lo
    catC_state          = $8577 ; catC AI state (rec+$07)
    catC_wp_lo          = $8588 ; catC waypoint ptr lo
    catC_wp_hi          = $8589 ; catC waypoint ptr hi
    catC_busy           = $858B ; catC busy lock
    catC_2ptr           = $858D ; catC secondary ptr lo
;;; --- record fields (snake control $8600 / snakes) ---
    snkA_spawn          = $8601 ; snakeA spawned (enable = snake_ctrl_86)
    snkB_en             = $8602 ; snakeB enable
    snkB_spawn          = $8603 ; snakeB spawned
    snk_init_a          = $8608 ; snakeA AI-path-initialised flag
    snk_init_b          = $8609 ; snakeB AI-path-initialised flag
    snkA_state          = $8617 ; snakeA AI state (rec+$07)
    snkA_wp_lo          = $8628 ; snakeA waypoint ptr lo
    snkA_wp_hi          = $8629 ; snakeA waypoint ptr hi
    snkA_busy           = $862B ; snakeA busy lock (rec+$1B)
    snkB_state          = $8637 ; snakeB AI state (rec+$07)
    snkB_wp_lo          = $8648 ; snakeB waypoint ptr lo
    snkB_wp_hi          = $8649 ; snakeB waypoint ptr hi
    snkB_busy           = $864B ; snakeB busy lock (rec+$1B)
;;; --- record fields (event object $85C0 / bomb $8680) ---
    event_trig          = $85C1 ; spawn trigger / enable
    event_seed_y        = $85C2 ; seeded Y (plr_y at spawn)
    event_seed_x        = $85C3 ; seeded X (plr_x at spawn)
    event_run           = $85C4 ; running sub-state
    event_y             = $85C5 ; current Y -> sprite +0
    event_x             = $85C6 ; current X -> sprite +3 (+2/frame)
    bomb_y              = $8684 ; Y (from plr_y)
    bomb_x              = $8685 ; X (from plr_x)
    bomb_tile           = $8686 ; tile ($3C)
    bomb_color          = $8687 ; color ($86)
    bomb_expframe       = $8688 ; explosion frame (0-5)
    bomb_expstage       = $8689 ; explosion stage
    bomb_armtimer       = $868A ; arming timer (to $14)
    bomb_detonate       = $868B ; detonate flag
...
;;; --- globals ---
    ...
    req_level_done      = $8032
    req_death           = $8033
    req_flags           = $8039 ; event bitmask (producer/consumer handshake)
    seq_state           = $803B ; 0..8 top-level state
    endlevel_active     = $803E ; level-end / freeze gate
...
;;; --- key routines ---
    ...
    level_end_seq       = $23D3 ; check_level_done, else end-level timer -> req_level_done
    check_level_done    = $2429 ; all 9 food_returned slots set? => start end-of-level seq
    player_update       = $2539
    ...
    bomb_update         = $100F ; drop / arm+detonate / explode
    bomb_collide        = $116D ; explosion AABB vs player + each cat/snake
    food_pickup         = $29C8 ; player over food tile ($DC-$EF) -> food_state 0->2 (carried)
    food_set_state      = $3EB2 ; find food piece at VRAM cell (hl), write reg c into food_state
    food_maze_erase     = $3F62 ; blank carried (state 2) food cells in maze (tile $25/$87)
    ...
    event_clear_enemies = $3ACC ; while pellet active: send every enemy to dying state $04
    bridge_update       = $3BFF ; bridge open/close tile animation
    platform_update     = $407D ; sliding platform (slot 2)
    scripted_move       = $3D0A ; scripted player move (home-entry)
...
0002: 00          nop
0003: 3E 00       ld   a,$00
0005: 32 00 B0    ld   (mainlatch),a
0008: C3 F1 07    jp   boot_selftest
000B: 00          nop
000C: 00          nop
000D: 00          nop
000E: 3A 00 B8    ld   a,(watchdog)
0011: 21 00 80    ld   hl,sprite_mirror
0014: 3E 88       ld   a,$88
0016: 0E 00       ld   c,$00
0018: 71          ld   (hl),c
0019: 23          inc  hl
...
0027: AF          xor  a
0028: 06 08       ld   b,$08
002A: 21 00 B0    ld   hl,mainlatch
002D: 77          ld   (hl),a
002E: 23          inc  hl
002F: 10 FC       djnz $002D
0031: 3A 00 B0    ld   a,(dsw)
...
0080: 00          nop
0081: 00          nop
0082: CD 00 01    call nmi_service
0085: 00          nop
0086: 00          nop
0087: 00          nop
0088: 00          nop
...
00FE: 00          nop
00FF: 00          nop
;;; ==== nmi_service ($0100) -- per-frame producer (called from NMI vector $0066) ====
0100: 00          nop
0101: 00          nop
0102: 00          nop
0103: CD 43 07    call read_inputs
0106: CD 29 06    call $0629
0109: 3A 30 80    ld   a,(game_mode)
010C: A7          and  a
010D: C2 EB 01    jp   nz,$01EB
0110: 3A 00 A8    ld   a,(in_coin)
0113: E6 08       and  $08
0115: C2 23 01    jp   nz,$0123
0118: 3A 00 A8    ld   a,(in_coin)
011B: E6 04       and  $04
...
0145: 3E 03       ld   a,$03
0147: 32 00 82    ld   (page_p1),a
014A: 32 00 83    ld   (page_p2),a
014D: C3 93 01    jp   $0193
0150: 3E 05       ld   a,$05
0152: 32 00 82    ld   (page_p1),a
0155: 32 00 83    ld   (page_p2),a
0158: C3 93 01    jp   $0193
015B: 3A 23 80    ld   a,($8023)
015E: A7          and  a
015F: CA EB 01    jp   z,$01EB
0162: 3E 01       ld   a,$01
0164: 32 30 80    ld   (game_mode),a
...
017C: 3E 03       ld   a,$03
017E: 32 00 82    ld   (page_p1),a
0181: 3E 00       ld   a,$00
0183: 32 00 83    ld   (page_p2),a
0186: C3 93 01    jp   $0193
0189: 3E 05       ld   a,$05
018B: 32 00 82    ld   (page_p1),a
018E: 3E 00       ld   a,$00
0190: 32 00 83    ld   (page_p2),a
0193: 3E 00       ld   a,$00
0195: 21 00 81    ld   hl,page_active
0198: 06 03       ld   b,$03
019A: 77          ld   (hl),a
019B: 2C          inc  l
...
01A3: 3E 00       ld   a,$00
01A5: 32 31 80    ld   (cur_player),a
01A8: 32 32 80    ld   (req_level_done),a
01AB: 32 33 80    ld   (req_death),a
...
01DF: 3A 39 80    ld   a,(req_flags)
01E2: CB E7       set  4,a
01E4: 32 39 80    ld   (req_flags),a
01E7: 00          nop
01E8: 00          nop
01E9: 00          nop
01EA: 00          nop
01EB: 3A 39 80    ld   a,(req_flags)
01EE: A7          and  a
01EF: C0          ret  nz
01F0: 3A 30 80    ld   a,(game_mode)
01F3: A7          and  a
01F4: C2 C7 02    jp   nz,$02C7
01F7: 3A 23 80    ld   a,($8023)
01FA: A7          and  a
01FB: C2 08 02    jp   nz,$0208
01FE: 3A 3B 80    ld   a,(seq_state)
0201: A7          and  a
0202: C2 42 02    jp   nz,$0242
0205: C3 88 02    jp   $0288
0208: FE 02       cp   $02
020A: D2 1B 02    jp   nc,$021B
020D: 3A 3B 80    ld   a,(seq_state)
0210: FE 02       cp   $02
0212: C8          ret  z
0213: 3E 01       ld   a,$01
0215: 32 39 80    ld   (req_flags),a
0218: C3 29 02    jp   $0229
021B: 3A 3B 80    ld   a,(seq_state)
021E: FE 03       cp   $03
0220: C8          ret  z
0221: 3E 02       ld   a,$02
0223: 32 39 80    ld   (req_flags),a
0226: C3 29 02    jp   $0229
0229: 21 00 81    ld   hl,page_active
022C: 3E 00       ld   a,$00
022E: 06 03       ld   b,$03
0230: 77          ld   (hl),a
0231: 2C          inc  l
...
0241: C9          ret
0242: 3A 33 80    ld   a,(req_death)
0245: A7          and  a
0246: CA 5E 02    jp   z,$025E
0249: 3A 3B 80    ld   a,(seq_state)
024C: FE 01       cp   $01
...
025E: 3A 32 80    ld   a,(req_level_done)
0261: A7          and  a
0262: CA AA 02    jp   z,$02AA
0265: 3A 3B 80    ld   a,(seq_state)
0268: FE 06       cp   $06
...
0275: 3E 00       ld   a,$00
0277: 32 33 80    ld   (req_death),a
027A: 32 32 80    ld   (req_level_done),a
027D: 3A 39 80    ld   a,(req_flags)
0280: CB EF       set  5,a
0282: 32 39 80    ld   (req_flags),a
0285: C3 29 02    jp   $0229
0288: 3E 00       ld   a,$00
028A: 32 33 80    ld   (req_death),a
028D: 32 32 80    ld   (req_level_done),a
0290: 3A 39 80    ld   a,(req_flags)
0293: CB FF       set  7,a
0295: 32 39 80    ld   (req_flags),a
0298: C9          ret
0299: 3E 00       ld   a,$00
029B: 32 33 80    ld   (req_death),a
029E: 32 32 80    ld   (req_level_done),a
02A1: 3A 39 80    ld   a,(req_flags)
02A4: CB F7       set  6,a
02A6: 32 39 80    ld   (req_flags),a
02A9: C9          ret
02AA: 3A 3B 80    ld   a,(seq_state)
02AD: FE 01       cp   $01
...
02CA: 3A 33 80    ld   a,(req_death)
02CD: A7          and  a
02CE: C2 98 03    jp   nz,$0398
02D1: 3A 32 80    ld   a,(req_level_done)
02D4: A7          and  a
02D5: C2 E0 04    jp   nz,$04E0
02D8: 3A 3B 80    ld   a,(seq_state)
02DB: FE 04       cp   $04
...
0318: C9          ret
0319: 3A 30 80    ld   a,(game_mode)
031C: FE 02       cp   $02
031E: CA 32 03    jp   z,$0332
0321: 3E 00       ld   a,$00
0323: 32 30 80    ld   (game_mode),a
0326: 32 3B 80    ld   (seq_state),a
0329: 3A 39 80    ld   a,(req_flags)
032C: CB D7       set  2,a
032E: 32 39 80    ld   (req_flags),a
0331: C9          ret
0332: 3A 31 80    ld   a,(cur_player)
0335: A7          and  a
...
0345: 3E 01       ld   a,$01
0347: 32 31 80    ld   (cur_player),a
034A: 3A 39 80    ld   a,(req_flags)
034D: CB E7       set  4,a
034F: 32 39 80    ld   (req_flags),a
0352: C9          ret
0353: 3E 01       ld   a,$01
...
035F: 3E 00       ld   a,$00
0361: 32 31 80    ld   (cur_player),a
0364: 3A 39 80    ld   a,(req_flags)
0367: CB E7       set  4,a
0369: 32 39 80    ld   (req_flags),a
036C: C9          ret
...
038E: C9          ret
038F: 3A 39 80    ld   a,(req_flags)
0392: CB EF       set  5,a
0394: 32 39 80    ld   (req_flags),a
0397: C9          ret
0398: 3A 3B 80    ld   a,(seq_state)
039B: FE 06       cp   $06
...
03BC: 21 00 81    ld   hl,page_active
03BF: 3E 00       ld   a,$00
03C1: BE          cp   (hl)
03C2: CA E9 03    jp   z,$03E9
03C5: 35          dec  (hl)
03C6: 21 00 81    ld   hl,page_active
03C9: 11 00 82    ld   de,page_p1
03CC: 01 FF 00    ld   bc,$00FF
03CF: ED B0       ldir
03D1: 3A 00 81    ld   a,(page_active)
03D4: A7          and  a
03D5: CA E9 03    jp   z,$03E9
03D8: 3E 00       ld   a,$00
03DA: 32 33 80    ld   (req_death),a
03DD: 32 32 80    ld   (req_level_done),a
03E0: 3A 39 80    ld   a,(req_flags)
03E3: CB E7       set  4,a
03E5: 32 39 80    ld   (req_flags),a
03E8: C9          ret
...
03FA: 21 00 81    ld   hl,page_active
03FD: 06 84       ld   b,$84
03FF: 3E 00       ld   a,$00
0401: 77          ld   (hl),a
0402: 2C          inc  l
...
040C: 3E 00       ld   a,$00
040E: 32 33 80    ld   (req_death),a
0411: 32 32 80    ld   (req_level_done),a
0414: 3A 39 80    ld   a,(req_flags)
0417: CB DF       set  3,a
0419: 32 39 80    ld   (req_flags),a
041C: C9          ret
041D: 21 00 81    ld   hl,page_active
0420: 3E 00       ld   a,$00
0422: BE          cp   (hl)
0423: CA 27 04    jp   z,$0427
0426: 35          dec  (hl)
0427: 3A 31 80    ld   a,(cur_player)
042A: A7          and  a
042B: CA 3C 04    jp   z,$043C
042E: 21 00 81    ld   hl,page_active
0431: 11 00 83    ld   de,page_p2
0434: 01 FF 00    ld   bc,$00FF
0437: ED B0       ldir
0439: C3 47 04    jp   $0447
043C: 21 00 81    ld   hl,page_active
043F: 11 00 82    ld   de,page_p1
0442: 01 FF 00    ld   bc,$00FF
0445: ED B0       ldir
0447: 3A 00 81    ld   a,(page_active)
044A: A7          and  a
044B: C2 73 04    jp   nz,$0473
044E: 3A 31 80    ld   a,(cur_player)
0451: A7          and  a
...
0462: 3E 00       ld   a,$00
0464: 32 33 80    ld   (req_death),a
0467: 32 32 80    ld   (req_level_done),a
046A: 3A 39 80    ld   a,(req_flags)
046D: CB DF       set  3,a
046F: 32 39 80    ld   (req_flags),a
0472: C9          ret
0473: 3A 31 80    ld   a,(cur_player)
0476: A7          and  a
0477: CA 84 04    jp   z,$0484
047A: 3A 00 82    ld   a,(page_p1)
047D: A7          and  a
047E: C2 C1 04    jp   nz,$04C1
0481: C3 8B 04    jp   $048B
0484: 3A 00 83    ld   a,(page_p2)
0487: A7          and  a
...
04AB: 3E 00       ld   a,$00
04AD: 32 33 80    ld   (req_death),a
04B0: 32 32 80    ld   (req_level_done),a
04B3: 3E 01       ld   a,$01
04B5: 32 31 80    ld   (cur_player),a
04B8: 3A 39 80    ld   a,(req_flags)
04BB: CB E7       set  4,a
04BD: 32 39 80    ld   (req_flags),a
04C0: C9          ret
04C1: 3E 00       ld   a,$00
04C3: 32 33 80    ld   (req_death),a
04C6: 32 32 80    ld   (req_level_done),a
04C9: 3E 00       ld   a,$00
04CB: 32 36 80    ld   ($8036),a
04CE: 32 06 B0    ld   ($B006),a
04D1: 32 07 B0    ld   ($B007),a
04D4: 32 31 80    ld   (cur_player),a
04D7: 3A 39 80    ld   a,(req_flags)
04DA: CB E7       set  4,a
04DC: 32 39 80    ld   (req_flags),a
04DF: C9          ret
04E0: 3A 3B 80    ld   a,(seq_state)
04E3: FE 06       cp   $06
...
04ED: C9          ret
04EE: 3E 00       ld   a,$00
04F0: 32 32 80    ld   (req_level_done),a
04F3: 32 33 80    ld   (req_death),a
04F6: 3E 08       ld   a,$08
04F8: 32 3B 80    ld   (seq_state),a
04FB: 3A 39 80    ld   a,(req_flags)
04FE: CB D7       set  2,a
0500: 32 39 80    ld   (req_flags),a
0503: C9          ret
...
0518: 3A 31 80    ld   a,(cur_player)
051B: A7          and  a
051C: CA 2D 05    jp   z,$052D
051F: 21 00 81    ld   hl,page_active
0522: 11 00 83    ld   de,page_p2
0525: 01 FF 00    ld   bc,$00FF
0528: ED B0       ldir
052A: C3 38 05    jp   $0538
052D: 21 00 81    ld   hl,page_active
0530: 11 00 82    ld   de,page_p1
0533: 01 FF 00    ld   bc,$00FF
0536: ED B0       ldir
0538: 3E 00       ld   a,$00
053A: 32 32 80    ld   (req_level_done),a
053D: 32 33 80    ld   (req_death),a
0540: 3A 39 80    ld   a,(req_flags)
0543: CB F7       set  6,a
0545: 32 39 80    ld   (req_flags),a
0548: C9          ret
0549: 00          nop
054A: 00          nop
054B: 00          nop
...
058B: 00          nop
058C: 3E 01       ld   a,$01
058E: 32 00 B0    ld   (mainlatch),a
0591: 32 02 B0    ld   ($B002),a
0594: 00          nop
0595: 00          nop
0596: 00          nop
0597: C3 D1 1F    jp   fg_loop
059A: 00          nop
059B: 00          nop
059C: 00          nop
059D: 00          nop
...
062A: 00          nop
062B: 00          nop
;;; ==== copy_sprites ($062C) -- ldir sprite_mirror $8000 -> spriteram $9840 ====
062C: 21 00 80    ld   hl,sprite_mirror
062F: 11 40 98    ld   de,spriteram
...
0644: 3A 31 80    ld   a,(cur_player)
0647: A7          and  a
0648: C2 53 06    jp   nz,$0653
064B: 21 44 80    ld   hl,p1_score
064E: 0E 00       ld   c,$00
...
06AA: 3A 00 81    ld   a,(page_active)
06AD: C6 01       add  a,$01
06AF: 32 00 81    ld   (page_active),a
...
0741: 12          ld   (de),a
0742: C9          ret
;;; ==== read_inputs ($0743) -- joystick/coin into work RAM ====
0743: FD 21 20 80 ld   iy,$8020
0747: 3A 00 A8    ld   a,(in_coin)
...
;;; ==== boot_selftest ($07F1) -- power-on ROM/RAM/VRAM test (jp $08DD on fail) ====
07F1: 3A 00 B8    ld   a,(watchdog)
07F4: 21 00 90    ld   hl,vram
07F7: 06 04       ld   b,$04
07F9: 3E 24       ld   a,$24
07FB: 77          ld   (hl),a
07FC: 2C          inc  l
...
082E: 16 00       ld   d,$00
0830: 0E 20       ld   c,$20
0832: 21 00 80    ld   hl,sprite_mirror
0835: 06 08       ld   b,$08
0837: 79          ld   a,c
0838: C6 2F       add  a,$2F
083A: 77          ld   (hl),a
...
0842: 21 00 80    ld   hl,sprite_mirror
0845: 06 08       ld   b,$08
...
100F: 3A 3E 80    ld   a,(endlevel_active)
1012: A7          and  a
1013: C2 38 10    jp   nz,$1038
1016: 3A 1F 84    ld   a,(plr_state)
1019: FE 02       cp   $02
101B: CA 38 10    jp   z,$1038
101E: 3A 1F 84    ld   a,(plr_state)
1021: FE 00       cp   $00
1023: CA 38 10    jp   z,$1038
1026: 3A 80 86    ld   a,(bomb)
1029: A7          and  a
102A: C2 ED 10    jp   nz,$10ED
102D: 32 83 86    ld   (bomb_lethal),a
1030: 3A 7F 86    ld   a,(bomb_supply)
1033: A7          and  a
1034: C8          ret  z
1035: C3 46 10    jp   $1046
1038: 21 80 86    ld   hl,bomb
103B: 3E 00       ld   a,$00
103D: 06 10       ld   b,$10
103F: 77          ld   (hl),a
1040: 23          inc  hl
...
1046: 3A C1 85    ld   a,(event_trig)
1049: A7          and  a
104A: C0          ret  nz
104B: 3A 01 84    ld   a,(plr_input)
104E: E6 10       and  $10
1050: C8          ret  z
1051: CD 1B 25    call pos_to_maze
1054: 11 E2 FF    ld   de,$FFE2
1057: 19          add  hl,de
1058: 7E          ld   a,(hl)
1059: FE F0       cp   $F0
105B: D8          ret  c
105C: 3A 7F 86    ld   a,(bomb_supply)
105F: A7          and  a
1060: C8          ret  z
1061: D6 01       sub  $01
1063: 32 7F 86    ld   (bomb_supply),a
...
1073: 3A 7F 86    ld   a,(bomb_supply)
1076: 0E 06       ld   c,$06
...
109D: C9          ret
109E: 3E 00       ld   a,$00
10A0: 32 83 86    ld   (bomb_lethal),a
10A3: 32 81 86    ld   ($8681),a
10A6: 32 82 86    ld   ($8682),a
10A9: 32 88 86    ld   (bomb_expframe),a
10AC: 32 89 86    ld   (bomb_expstage),a
10AF: 32 8A 86    ld   (bomb_armtimer),a
10B2: 32 8B 86    ld   (bomb_detonate),a
10B5: 3E 01       ld   a,$01
10B7: 32 80 86    ld   (bomb),a
10BA: 21 84 86    ld   hl,bomb_y
10BD: 3A 06 84    ld   a,(plr_y)
10C0: 77          ld   (hl),a
10C1: 23          inc  hl
10C2: 3A 07 84    ld   a,(plr_x)
10C5: 77          ld   (hl),a
10C6: 23          inc  hl
10C7: 3E 3C       ld   a,$3C
10C9: 77          ld   (hl),a
...
10D9: 3A 84 86    ld   a,(bomb_y)
10DC: 77          ld   (hl),a
10DD: 23          inc  hl
10DE: 3A 86 86    ld   a,(bomb_tile)
10E1: 77          ld   (hl),a
10E2: 23          inc  hl
10E3: 3A 87 86    ld   a,(bomb_color)
10E6: 77          ld   (hl),a
10E7: 23          inc  hl
10E8: 3A 85 86    ld   a,(bomb_x)
10EB: 77          ld   (hl),a
10EC: C9          ret
10ED: 3A 8B 86    ld   a,(bomb_detonate)
10F0: A7          and  a
10F1: C2 0D 11    jp   nz,$110D
10F4: 3A 8A 86    ld   a,(bomb_armtimer)
10F7: FE 14       cp   $14
10F9: CA 01 11    jp   z,$1101
10FC: 3C          inc  a
10FD: 32 8A 86    ld   (bomb_armtimer),a
1100: C9          ret
1101: 3A 01 84    ld   a,(plr_input)
1104: E6 10       and  $10
1106: C8          ret  z
1107: 3E 01       ld   a,$01
1109: 32 8B 86    ld   (bomb_detonate),a
110C: C9          ret
110D: 21 88 86    ld   hl,bomb_expframe
1110: 34          inc  (hl)
1111: 7E          ld   a,(hl)
1112: FE 06       cp   $06
1114: D8          ret  c
...
1133: C9          ret
1134: 3E 3E       ld   a,$3E
1136: 32 86 86    ld   (bomb_tile),a
1139: 3E 87       ld   a,$87
113B: 32 87 86    ld   (bomb_color),a
113E: 3E 01       ld   a,$01
1140: 32 83 86    ld   (bomb_lethal),a
1143: 3E 88       ld   a,$88
1145: 32 00 B8    ld   (watchdog),a
1148: C3 D6 10    jp   $10D6
114B: C3 D6 10    jp   $10D6
114E: 3E 3F       ld   a,$3F
1150: 32 86 86    ld   (bomb_tile),a
1153: 3E 84       ld   a,$84
1155: 32 87 86    ld   (bomb_color),a
1158: C3 D6 10    jp   $10D6
115B: 3E 3D       ld   a,$3D
115D: 32 86 86    ld   (bomb_tile),a
1160: 3E 87       ld   a,$87
1162: 32 87 86    ld   (bomb_color),a
1165: C3 D6 10    jp   $10D6
1168: C3 38 10    jp   $1038
116B: 00          nop
116C: 00          nop
;;; ==== bomb_collide ($116D) -- while bomb_lethal ($8683): explosion AABB vs player + enemies ====
116D: 3A 83 86    ld   a,(bomb_lethal)
1170: A7          and  a
1171: C8          ret  z
1172: 3A 00 B0    ld   a,(dsw)
1175: E6 80       and  $80
1177: C2 8C 11    jp   nz,$118C
117A: 3A 1F 84    ld   a,(plr_state)
117D: FE 01       cp   $01
117F: C2 8C 11    jp   nz,$118C
1182: 3A 3E 80    ld   a,(endlevel_active)
1185: A7          and  a
...
119E: C9          ret
119F: DD 21 00 80 ld   ix,sprite_mirror
...
11D7: D9          exx
11D8: E9          jp   (hl)
11D9: 3A 01 85    ld   a,(catA_spawn)
11DC: A7          and  a
11DD: C8          ret  z
11DE: 3A 2B 85    ld   a,(catA_busy)
11E1: A7          and  a
11E2: C0          ret  nz
...
11F8: 21 17 85    ld   hl,catA_state
11FB: 36 06       ld   (hl),$06
11FD: 21 2B 85    ld   hl,catA_busy
1200: 36 01       ld   (hl),$01
...
1231: 3A 04 85    ld   a,(catB_en)
1234: A7          and  a
1235: C8          ret  z
1236: 3A 6B 85    ld   a,(catB_busy)
1239: A7          and  a
123A: C0          ret  nz
...
1250: 21 57 85    ld   hl,catB_state
1253: 36 06       ld   (hl),$06
1255: 21 6B 85    ld   hl,catB_busy
1258: 36 01       ld   (hl),$01
125A: C3 86 12    jp   $1286
125D: 3A 07 85    ld   a,(catC_spawn)
1260: A7          and  a
1261: C8          ret  z
1262: 3A 8B 85    ld   a,(catC_busy)
1265: A7          and  a
1266: C0          ret  nz
...
127C: 21 77 85    ld   hl,catC_state
127F: 36 06       ld   (hl),$06
1281: 21 8B 85    ld   hl,catC_busy
1284: 36 01       ld   (hl),$01
1286: 3E 83       ld   a,$83
...
1290: C9          ret
1291: 3A 01 86    ld   a,(snkA_spawn)
1294: A7          and  a
1295: C8          ret  z
1296: 3A 2B 86    ld   a,(snkA_busy)
1299: A7          and  a
129A: C0          ret  nz
...
12B0: 21 17 86    ld   hl,snkA_state
12B3: 36 06       ld   (hl),$06
12B5: 21 2B 86    ld   hl,snkA_busy
12B8: 36 01       ld   (hl),$01
12BA: C3 E6 12    jp   $12E6
12BD: 3A 03 86    ld   a,(snkB_spawn)
12C0: A7          and  a
12C1: C8          ret  z
12C2: 3A 4B 86    ld   a,(snkB_busy)
12C5: A7          and  a
12C6: C0          ret  nz
...
12DC: 21 37 86    ld   hl,snkB_state
12DF: 36 06       ld   (hl),$06
12E1: 21 4B 86    ld   hl,snkB_busy
12E4: 36 01       ld   (hl),$01
12E6: 3E 82       ld   a,$82
...
1309: 77          ld   (hl),a
130A: C9          ret
;;; ==== load_maze ($130B) -- (level & 3) -> bank $1391/$16A1/$19B1/$1CC1 ====
...
1FCF: 25          dec  h
1FD0: 25          dec  h
;;; ==== fg_loop ($1FD1) -- foreground consumer: dispatch on req_flags ($8039) ====
1FD1: 3A 39 80    ld   a,(req_flags)
1FD4: A7          and  a
1FD5: C2 E3 1F    jp   nz,$1FE3
1FD8: 3A 3B 80    ld   a,(seq_state)
1FDB: FE 06       cp   $06
1FDD: C2 E0 1F    jp   nz,$1FE0
1FE0: C3 D1 1F    jp   fg_loop
1FE3: 0F          rrca
...
2003: AF          xor  a
2004: 32 39 80    ld   (req_flags),a
2007: C3 D1 1F    jp   fg_loop
200A: CD EC 20    call $20EC
200D: 21 00 85    ld   hl,cat_ctrl_85
2010: 06 10       ld   b,$10
2012: 3E 00       ld   a,$00
2014: 77          ld   (hl),a
2015: 23          inc  hl
2016: 10 FC       djnz $2014
2018: 21 00 86    ld   hl,snake_ctrl_86
201B: 06 10       ld   b,$10
201D: 77          ld   (hl),a
201E: 23          inc  hl
201F: 10 FC       djnz $201D
2021: 32 00 84    ld   (player_ws),a
2024: 21 9C 80    ld   hl,$809C
2027: 06 60       ld   b,$60
2029: 77          ld   (hl),a
202A: 23          inc  hl
202B: 10 FC       djnz $2029
202D: 3A 31 80    ld   a,(cur_player)
2030: A7          and  a
2031: C2 3A 20    jp   nz,$203A
2034: 21 00 82    ld   hl,page_p1
2037: C3 3D 20    jp   $203D
203A: 21 00 83    ld   hl,page_p2
203D: 11 00 81    ld   de,page_active
2040: 01 FF 00    ld   bc,$00FF
2043: ED B0       ldir
2045: CD 82 20    call $2082
2048: CD 9D 20    call $209D
204B: CD 0B 13    call load_maze
204E: CD 29 3E    call food_maze_redraw
...
206A: 3E 05       ld   a,$05
206C: 32 7F 86    ld   (bomb_supply),a
206F: CD 6C 10    call $106C
2072: 3E 06       ld   a,$06
2074: 32 3B 80    ld   (seq_state),a
2077: 3A 39 80    ld   a,(req_flags)
207A: CB AF       res  5,a
207C: 32 39 80    ld   (req_flags),a
207F: C3 D1 1F    jp   fg_loop
...
20BF: 3E 07       ld   a,$07
20C1: 32 3B 80    ld   (seq_state),a
20C4: 3E E0       ld   a,$E0
20C6: 32 00 B8    ld   (watchdog),a
20C9: 3E 00       ld   a,$00
20CB: 32 80 84    ld   ($8480),a
20CE: 3A 39 80    ld   a,(req_flags)
20D1: CB B7       res  6,a
20D3: 32 39 80    ld   (req_flags),a
20D6: C3 D1 1F    jp   fg_loop
20D9: CD EC 20    call $20EC
20DC: 3E 01       ld   a,$01
20DE: 32 3B 80    ld   (seq_state),a
20E1: 3A 39 80    ld   a,(req_flags)
20E4: CB BF       res  7,a
20E6: 32 39 80    ld   (req_flags),a
20E9: C3 D1 1F    jp   fg_loop
...
2123: 21 00 80    ld   hl,sprite_mirror
2126: 06 20       ld   b,$20
2128: 36 00       ld   (hl),$00
212A: 2C          inc  l
...
21B3: AF          xor  a
21B4: 32 33 80    ld   (req_death),a
21B7: 32 32 80    ld   (req_level_done),a
21BA: 3E 02       ld   a,$02
21BC: 32 3B 80    ld   (seq_state),a
21BF: 3A 39 80    ld   a,(req_flags)
21C2: CB 87       res  0,a
21C4: 32 39 80    ld   (req_flags),a
21C7: C3 D1 1F    jp   fg_loop
...
21DF: AF          xor  a
21E0: 32 33 80    ld   (req_death),a
21E3: 32 32 80    ld   (req_level_done),a
21E6: 3E 03       ld   a,$03
21E8: 32 3B 80    ld   (seq_state),a
21EB: 3A 39 80    ld   a,(req_flags)
21EE: CB 8F       res  1,a
21F0: 32 39 80    ld   (req_flags),a
21F3: C3 D1 1F    jp   fg_loop
21F6: CD EC 20    call $20EC
21F9: 3A 39 80    ld   a,(req_flags)
21FC: CB 97       res  2,a
21FE: 32 39 80    ld   (req_flags),a
2201: C3 D1 1F    jp   fg_loop
2204: CD EC 20    call $20EC
2207: 21 72 23    ld   hl,$2372
220A: CD 2E 21    call $212E
220D: 3A 30 80    ld   a,(game_mode)
2210: FE 01       cp   $01
...
2261: 3E 04       ld   a,$04
2263: 32 3B 80    ld   (seq_state),a
2266: 3A 39 80    ld   a,(req_flags)
2269: CB 9F       res  3,a
226B: 32 39 80    ld   (req_flags),a
226E: C3 D1 1F    jp   fg_loop
...
22F2: 3E 05       ld   a,$05
22F4: 32 3B 80    ld   (seq_state),a
22F7: 3E 40       ld   a,$40
22F9: 32 3D 80    ld   ($803D),a
22FC: 3A 39 80    ld   a,(req_flags)
22FF: CB A7       res  4,a
2301: 32 39 80    ld   (req_flags),a
2304: C3 D1 1F    jp   fg_loop
2307: 3A 31 80    ld   a,(cur_player)
230A: 21 00 82    ld   hl,page_p1
230D: A7          and  a
...
232D: C9          ret
232E: 21 00 81    ld   hl,page_active
2331: 7E          ld   a,(hl)
2332: 3D          dec  a
...
238F: 24          inc  h
2390: FF          rst  $38
2391: 3A 1F 84    ld   a,(plr_state)
2394: FE 02       cp   $02
2396: CA C5 23    jp   z,$23C5
2399: 3A 3E 80    ld   a,(endlevel_active)
239C: A7          and  a
239D: C2 C9 23    jp   nz,$23C9
;;; ==== ingame_update ($23A0) -- per-frame game pipeline (only in state 6) ====
;;; platform / bridge / scripted-move / cat_mgr / snake_mgr / player_update /
;;; enemy_eaten / level_end_seq / player_vs_enemy / bomb_collide / bomb / event.
23A0: CD 7D 40    call platform_update
23A3: CD FF 3B    call bridge_update
23A6: CD 0A 3D    call scripted_move
23A9: CD 51 2A    call cat_mgr
23AC: CD 06 32    call snake_mgr
23AF: CD 39 25    call player_update
23B2: CD 4B 39    call enemy_eaten_sm
23B5: CD D3 23    call level_end_seq
23B8: CD 2A 39    call player_vs_enemy
23BB: CD 6D 11    call bomb_collide
23BE: CD 0F 10    call bomb_update
23C1: CD BC 41    call $41BC
23C4: C9          ret
23C5: CD 39 25    call player_update
23C8: C9          ret
23C9: CD 51 2A    call cat_mgr
23CC: CD 06 32    call snake_mgr
23CF: CD D3 23    call level_end_seq
23D2: C9          ret
;;; ==== level_end_seq ($23D3) -- called each frame from ingame_update ====
;;; Guard: ret if death pending (req_death $8033) or player dead (plr_state==2).
;;; While endlevel_active ($803E)==0 -> run check_level_done ($2429).
;;; Once set -> bump endlevel_ctr ($803F); at $F0 set req_level_done ($8032)=1.
23D3: 3A 33 80    ld   a,(req_death)
23D6: A7          and  a
23D7: C0          ret  nz
23D8: 3A 1F 84    ld   a,(plr_state)
23DB: FE 02       cp   $02
23DD: C8          ret  z
23DE: 3A 3E 80    ld   a,(endlevel_active)
23E1: A7          and  a
23E2: CA 29 24    jp   z,check_level_done
23E5: 3A 3F 80    ld   a,(endlevel_ctr)
23E8: 3C          inc  a
23E9: 32 3F 80    ld   (endlevel_ctr),a
23EC: FE 02       cp   $02
...
241D: 32 3E 80    ld   (endlevel_active),a
2420: 32 3F 80    ld   (endlevel_ctr),a
2423: 3E 01       ld   a,$01
2425: 32 32 80    ld   (req_level_done),a
2428: C9          ret
;;; ==== check_level_done ($2429) ====
;;; Scan the 9-entry food_returned log ($8140, 2 bytes each). On the first
;;; still-zero slot -> ret (level not done). If all 9 are nonzero (every food
;;; piece carried home) => start end-of-level seq: force-kill surviving snakes
;;; ($8617/$8637 -> state $06, +$08 BCD bonus), set endlevel_active ($803E)=1.
2429: 21 40 81    ld   hl,food_returned
242C: 3E 00       ld   a,$00
242E: 06 09       ld   b,$09
2430: BE          cp   (hl)
2431: C8          ret  z
...
2436: 16 00       ld   d,$00
2438: 3A 2B 86    ld   a,(snkA_busy)
243B: A7          and  a
243C: C2 49 24    jp   nz,$2449
243F: 3E 06       ld   a,$06
2441: 32 17 86    ld   (snkA_state),a
2444: 3E 08       ld   a,$08
2446: 82          add  a,d
2447: 27          daa
2448: 57          ld   d,a
2449: 3A 4B 86    ld   a,(snkB_busy)
244C: A7          and  a
244D: C2 5A 24    jp   nz,$245A
2450: 3E 06       ld   a,$06
2452: 32 37 86    ld   (snkB_state),a
2455: 3E 08       ld   a,$08
2457: 82          add  a,d
2458: 27          daa
2459: 57          ld   d,a
...
245D: 3E 01       ld   a,$01
245F: 32 3E 80    ld   (endlevel_active),a
2462: 3E E0       ld   a,$E0
...
251B: 3A 07 84    ld   a,(plr_x)
251E: 0F          rrca
251F: 0F          rrca
2520: 0F          rrca
2521: E6 1F       and  $1F
2523: 5F          ld   e,a
2524: 3A 06 84    ld   a,(plr_y)
2527: ED 44       neg
2529: 07          rlca
252A: 07          rlca
252B: 57          ld   d,a
...
2531: E6 03       and  $03
2533: 57          ld   d,a
2534: 21 00 90    ld   hl,vram
2537: 19          add  hl,de
2538: C9          ret
;;; ==== player_update ($2539) -- init from template $246C if idle, then update ====
2539: 3A 00 84    ld   a,(player_ws)
253C: A7          and  a
253D: C2 54 25    jp   nz,$2554
2540: 11 00 84    ld   de,player_ws
...
2553: C9          ret
2554: 21 02 84    ld   hl,plr_frame
2557: 34          inc  (hl)
2558: CB 46       bit  0,(hl)
255A: CA D2 28    jp   z,$28D2
255D: 3A 30 80    ld   a,(game_mode)
2560: A7          and  a
2561: C2 71 25    jp   nz,$2571
2564: 21 23 84    ld   hl,plr_idle
2567: 7E          ld   a,(hl)
2568: 35          dec  (hl)
2569: A7          and  a
...
2571: 3A 00 A0    ld   a,(in_joy)
2574: 32 01 84    ld   (plr_input),a
2577: CD 98 25    call $2598
257A: 3A 22 84    ld   a,(plr_lock)
257D: A7          and  a
257E: C2 94 25    jp   nz,$2594
2581: CD B6 26    call $26B6
2584: 3A 08 84    ld   a,(plr_yvel)
2587: 47          ld   b,a
2588: 3A 09 84    ld   a,(plr_xvel)
258B: B0          or   b
258C: C2 94 25    jp   nz,$2594
258F: 3E 00       ld   a,$00
2591: 32 16 84    ld   (plr_moving),a
2594: CD 53 28    call $2853
2597: C9          ret
2598: 3A 1F 84    ld   a,(plr_state)
259B: FE 01       cp   $01
259D: CA BC 25    jp   z,$25BC
25A0: 08          ex   af,af'
25A1: 3E 00       ld   a,$00
25A3: 32 16 84    ld   (plr_moving),a
25A6: 08          ex   af,af'
25A7: FE 02       cp   $02
...
25BB: C9          ret
25BC: 3E 01       ld   a,$01
25BE: 32 16 84    ld   (plr_moving),a
25C1: C9          ret
25C2: 21 20 84    ld   hl,plr_substate
25C5: 7E          ld   a,(hl)
25C6: A7          and  a
...
25D0: 77          ld   (hl),a
25D1: 3E 01       ld   a,$01
25D3: 32 22 84    ld   (plr_lock),a
25D6: 3E 0C       ld   a,$0C
25D8: 32 13 84    ld   (plr_tile),a
...
25FC: C9          ret
25FD: 3E 0D       ld   a,$0D
25FF: 32 13 84    ld   (plr_tile),a
2602: C9          ret
2603: 3E 0E       ld   a,$0E
2605: 32 13 84    ld   (plr_tile),a
2608: C9          ret
2609: 3E 0F       ld   a,$0F
260B: 32 13 84    ld   (plr_tile),a
260E: 3E 00       ld   a,$00
2610: 32 1F 84    ld   (plr_state),a
2613: 3E A0       ld   a,$A0
2615: 32 00 B8    ld   (watchdog),a
2618: C9          ret
2619: 3E 00       ld   a,$00
261B: 32 00 84    ld   (player_ws),a
261E: 32 20 84    ld   (plr_substate),a
2621: 32 06 84    ld   (plr_y),a
2624: 32 07 84    ld   (plr_x),a
2627: 3E 01       ld   a,$01
2629: 32 33 80    ld   (req_death),a
262C: C9          ret
262D: 21 20 84    ld   hl,plr_substate
2630: 7E          ld   a,(hl)
2631: A7          and  a
2632: C2 47 26    jp   nz,$2647
2635: 3E 01       ld   a,$01
2637: 77          ld   (hl),a
2638: 32 22 84    ld   (plr_lock),a
263B: 3E 00       ld   a,$00
263D: 32 29 84    ld   (plr_death_step),a
2640: 32 2A 84    ld   (plr_death_fall),a
2643: CD 18 28    call $2818
2646: C9          ret
2647: 3A 2A 84    ld   a,(plr_death_fall)
264A: A7          and  a
264B: C2 74 26    jp   nz,$2674
264E: 3A 07 84    ld   a,(plr_x)
2651: C6 02       add  a,$02
2653: 32 07 84    ld   (plr_x),a
2656: FE E0       cp   $E0
2658: D2 8B 26    jp   nc,$268B
265B: CD 1B 25    call pos_to_maze
...
266D: C9          ret
266E: 3E 01       ld   a,$01
2670: 32 2A 84    ld   (plr_death_fall),a
2673: C9          ret
2674: 3A 29 84    ld   a,(plr_death_step)
2677: 3C          inc  a
2678: 32 29 84    ld   (plr_death_step),a
267B: FE 02       cp   $02
...
268A: C9          ret
268B: 3E 00       ld   a,$00
268D: 32 20 84    ld   (plr_substate),a
2690: 3E 02       ld   a,$02
2692: 32 1F 84    ld   (plr_state),a
2695: C9          ret
2696: 3E 0D       ld   a,$0D
2698: 32 13 84    ld   (plr_tile),a
269B: C9          ret
269C: 3E 0E       ld   a,$0E
269E: 32 13 84    ld   (plr_tile),a
26A1: C9          ret
26A2: 3E 0F       ld   a,$0F
26A4: 32 13 84    ld   (plr_tile),a
26A7: 3E 00       ld   a,$00
26A9: 32 1F 84    ld   (plr_state),a
26AC: 3E A0       ld   a,$A0
26AE: 32 00 B8    ld   (watchdog),a
26B1: C9          ret
26B2: CD 0A 3D    call scripted_move
26B5: C9          ret
26B6: 3A 07 84    ld   a,(plr_x)
26B9: E6 07       and  $07
26BB: FE 02       cp   $02
26BD: C0          ret  nz
26BE: 3A 06 84    ld   a,(plr_y)
26C1: E6 07       and  $07
26C3: FE 04       cp   $04
26C5: C0          ret  nz
26C6: 3A 01 84    ld   a,(plr_input)
26C9: 0F          rrca
...
273B: E1          pop  hl
273C: 3A 0B 84    ld   a,(plr_vel_d1)
273F: 32 08 84    ld   (plr_yvel),a
2742: 3E 00       ld   a,$00
2744: 32 09 84    ld   (plr_xvel),a
2747: 3E 01       ld   a,$01
2749: 32 04 84    ld   (plr_facing),a
274C: 3E 00       ld   a,$00
274E: 32 14 84    ld   (plr_orient),a
2751: C9          ret
2752: 3A 06 84    ld   a,(plr_y)
2755: FE D4       cp   $D4
2757: CA 29 28    jp   z,$2829
275A: DA 65 27    jp   c,$2765
275D: 3E D4       ld   a,$D4
275F: 32 06 84    ld   (plr_y),a
2762: C3 29 28    jp   $2829
2765: CD 1B 25    call pos_to_maze
...
277D: E1          pop  hl
277E: 3A 0D 84    ld   a,(plr_vel_d2)
2781: 32 08 84    ld   (plr_yvel),a
2784: 3E 00       ld   a,$00
2786: 32 09 84    ld   (plr_xvel),a
2789: 3E 02       ld   a,$02
278B: 32 04 84    ld   (plr_facing),a
278E: 3E 80       ld   a,$80
2790: 32 14 84    ld   (plr_orient),a
2793: C9          ret
2794: 3A 07 84    ld   a,(plr_x)
2797: FE E2       cp   $E2
2799: CA 3E 28    jp   z,$283E
279C: DA A7 27    jp   c,$27A7
279F: 3E E2       ld   a,$E2
27A1: 32 07 84    ld   (plr_x),a
27A4: C3 3E 28    jp   $283E
27A7: CD 1B 25    call pos_to_maze
...
27BF: E1          pop  hl
27C0: 3A 0F 84    ld   a,(plr_vel_d4)
27C3: 32 09 84    ld   (plr_xvel),a
27C6: 3E 00       ld   a,$00
27C8: 32 08 84    ld   (plr_yvel),a
27CB: 3E 04       ld   a,$04
27CD: 32 04 84    ld   (plr_facing),a
27D0: 3E 04       ld   a,$04
27D2: 32 14 84    ld   (plr_orient),a
27D5: C9          ret
27D6: 3A 07 84    ld   a,(plr_x)
27D9: FE 22       cp   $22
27DB: CA 3E 28    jp   z,$283E
27DE: D2 E9 27    jp   nc,$27E9
27E1: 3E 22       ld   a,$22
27E3: 32 07 84    ld   (plr_x),a
27E6: C3 3E 28    jp   $283E
27E9: CD 1B 25    call pos_to_maze
...
2801: E1          pop  hl
2802: 3A 11 84    ld   a,(plr_vel_d8)
2805: 32 09 84    ld   (plr_xvel),a
2808: 3E 00       ld   a,$00
280A: 32 08 84    ld   (plr_yvel),a
280D: 3E 08       ld   a,$08
280F: 32 04 84    ld   (plr_facing),a
2812: 3E 08       ld   a,$08
2814: 32 14 84    ld   (plr_orient),a
2817: C9          ret
2818: 3E 00       ld   a,$00
281A: 32 08 84    ld   (plr_yvel),a
281D: 3E 00       ld   a,$00
281F: 32 09 84    ld   (plr_xvel),a
2822: 3E 00       ld   a,$00
2824: 32 16 84    ld   (plr_moving),a
2827: 00          nop
2828: C9          ret
2829: 3E 00       ld   a,$00
282B: 32 08 84    ld   (plr_yvel),a
282E: 00          nop
282F: 3A 09 84    ld   a,(plr_xvel)
2832: A7          and  a
2833: C8          ret  z
2834: FE 80       cp   $80
...
283D: C9          ret
283E: 3E 00       ld   a,$00
2840: 32 09 84    ld   (plr_xvel),a
2843: 00          nop
2844: 3A 08 84    ld   a,(plr_yvel)
2847: A7          and  a
2848: C8          ret  z
2849: FE 80       cp   $80
...
2851: 00          nop
2852: C9          ret
2853: 3A 22 84    ld   a,(plr_lock)
2856: A7          and  a
2857: C2 BB 28    jp   nz,$28BB
285A: 3A 08 84    ld   a,(plr_yvel)
285D: 47          ld   b,a
285E: 3A 06 84    ld   a,(plr_y)
2861: 80          add  a,b
2862: 32 06 84    ld   (plr_y),a
2865: 3A 09 84    ld   a,(plr_xvel)
2868: 47          ld   b,a
2869: 3A 07 84    ld   a,(plr_x)
286C: 80          add  a,b
286D: 32 07 84    ld   (plr_x),a
2870: 3A 16 84    ld   a,(plr_moving)
2873: A7          and  a
2874: CA BB 28    jp   z,$28BB
2877: 3A 17 84    ld   a,(plr_animsub)
287A: 3C          inc  a
287B: CB 47       bit  0,a
287D: CA AC 28    jp   z,$28AC
2880: 3A 18 84    ld   a,(plr_animidx)
2883: 3C          inc  a
2884: E6 03       and  $03
2886: 32 18 84    ld   (plr_animidx),a
2889: FE 00       cp   $00
...
28A7: 3E 03       ld   a,$03
28A9: 32 15 84    ld   (plr_animframe),a
28AC: 3A 14 84    ld   a,(plr_orient)
28AF: E6 FC       and  $FC
28B1: 47          ld   b,a
28B2: 3A 18 84    ld   a,(plr_animidx)
28B5: E6 03       and  $03
28B7: B0          or   b
28B8: 32 13 84    ld   (plr_tile),a
28BB: 21 00 80    ld   hl,sprite_mirror
28BE: 3A 06 84    ld   a,(plr_y)
28C1: 77          ld   (hl),a
28C2: 23          inc  hl
28C3: 3A 13 84    ld   a,(plr_tile)
28C6: 77          ld   (hl),a
28C7: 23          inc  hl
28C8: 3A 12 84    ld   a,(plr_color)
28CB: 77          ld   (hl),a
28CC: 23          inc  hl
28CD: 3A 07 84    ld   a,(plr_x)
28D0: 77          ld   (hl),a
28D1: C9          ret
28D2: 3A 07 84    ld   a,(plr_x)
28D5: E6 07       and  $07
28D7: FE 02       cp   $02
28D9: C0          ret  nz
28DA: 3A 06 84    ld   a,(plr_y)
28DD: E6 07       and  $07
28DF: FE 04       cp   $04
28E1: C0          ret  nz
28E2: CD 1B 25    call pos_to_maze
28E5: E5          push hl
...
28F0: 3E 01       ld   a,$01
28F2: 32 2D 84    ld   (plr_over_hole),a
28F5: E1          pop  hl
28F6: 3A 22 84    ld   a,(plr_lock)
28F9: A7          and  a
...
2910: E1          pop  hl
2911: E5          push hl
2912: CD C8 29    call food_pickup
2915: E1          pop  hl
...
292D: FE 3A       cp   $3A
292F: C0          ret  nz
2930: 3A 80 86    ld   a,(bomb)
2933: A7          and  a
2934: C0          ret  nz
2935: 3A C1 85    ld   a,(event_trig)
2938: A7          and  a
2939: C0          ret  nz
293A: 3E 01       ld   a,$01
293C: 32 C1 85    ld   (event_trig),a
293F: 3A 06 84    ld   a,(plr_y)
2942: 32 C2 85    ld   (event_seed_y),a
2945: 3A 07 84    ld   a,(plr_x)
2948: 32 C3 85    ld   (event_seed_x),a
294B: C9          ret
...
295F: FE FF       cp   $FF
2961: C0          ret  nz
2962: 3A 2D 84    ld   a,(plr_over_hole)
2965: A7          and  a
2966: C8          ret  z
2967: 3A 07 84    ld   a,(plr_x)
296A: FE 70       cp   $70
296C: D2 7D 29    jp   nc,$297D
296F: 0E 01       ld   c,$01
2971: 3A 14 84    ld   a,(plr_orient)
2974: 07          rlca
2975: D2 8B 29    jp   nc,$298B
2978: 0E 02       ld   c,$02
297A: C3 8B 29    jp   $298B
297D: 0E 21       ld   c,$21
297F: 3A 14 84    ld   a,(plr_orient)
2982: 07          rlca
...
2990: C8          ret  z
2991: 3E 05       ld   a,$05
2993: 32 1F 84    ld   (plr_state),a
2996: 3E 01       ld   a,$01
2998: 32 22 84    ld   (plr_lock),a
299B: 3E 00       ld   a,$00
299D: 32 2D 84    ld   (plr_over_hole),a
29A0: C9          ret
...
29C7: C9          ret
;;; ==== food_pickup ($29C8) -- link in tile dispatcher $28E2; carry-one-at-a-time ====
;;; No-op if already carrying / platform active ($80A0). If the player's cell tile is in
;;; food range $DC..$EF: c=$02, food_set_state marks it carried (food_state 0->2), stash
;;; carried-food block $809C/$809E/$809F/$80A0=1, food_maze_erase, score + sound $84.
...
29D7: D0          ret  nc
29D8: 0E 02       ld   c,$02
29DA: CD B2 3E    call food_set_state
...
2A2B: C5          push bc
2A2C: F5          push af
2A2D: CD 62 3F    call food_maze_erase
...
2B42: 3A 3E 80    ld   a,(endlevel_active)
2B45: A7          and  a
2B46: C0          ret  nz
2B47: 36 01       ld   (hl),$01
2B49: 11 10 85    ld   de,cat_rec_a
...
2C3B: 00          nop
;;; ==== cat_ai ($2C3E) -- per-enemy state engine (cats) ====
;;; NOTE: naive linear disasm is misaligned here. The real entry $2C3E is the
;;; byte $E5 (push hl) hidden inside "2C3C: 01 00 E5 ld bc,$E500". Decoding from
;;; $2C3E: push hl / ex de,hl / ld hl,$0018 / add hl,de  (-> rec+$18 AI ptr).
...
2C6F: C9          ret
2C70: 3A 3E 80    ld   a,(endlevel_active)
2C73: A7          and  a
2C74: C0          ret  nz
2C75: EB          ex   de,hl
2C76: 42          ld   b,d
...
2D0B: 36 08       ld   (hl),$08
2D0D: C9          ret
;;; ==== enemy_chase ($2D0E) -- steer enemy toward player sprite ($8000/$8003) ====
2D0E: 42          ld   b,d
2D0F: 4B          ld   c,e
2D10: 54          ld   d,h
2D11: 5D          ld   e,l
...
2D32: 3E 00       ld   a,$00
2D34: 02          ld   (bc),a
2D35: 3A 00 80    ld   a,(sprite_mirror)
2D38: BE          cp   (hl)
2D39: EB          ex   de,hl
...
2D5C: E6 03       and  $03
2D5E: FE 00       cp   $00
2D60: C4 0E 2D    call nz,enemy_chase
2D63: EB          ex   de,hl
...
2D73: E6 03       and  $03
2D75: FE 02       cp   $02
2D77: C4 0E 2D    call nz,enemy_chase
2D7A: EB          ex   de,hl
...
2D8A: E6 07       and  $07
2D8C: FE 05       cp   $05
2D8E: C4 0E 2D    call nz,enemy_chase
2D91: EB          ex   de,hl
...
2DA4: E6 07       and  $07
2DA6: FE 07       cp   $07
2DA8: C4 0E 2D    call nz,enemy_chase
2DAB: EB          ex   de,hl
...
2DC8: EB          ex   de,hl
2DC9: CD B3 30    call tile_addr_actor
...
2ED7: 13          inc  de
2ED8: CD B3 30    call tile_addr_actor
2EDB: 44          ld   b,h
2EDC: 4D          ld   c,l
...
2F23: 13          inc  de
2F24: CD B3 30    call tile_addr_actor
2F27: 44          ld   b,h
2F28: 4D          ld   c,l
...
2F70: CD B3 30    call tile_addr_actor
2F73: 44          ld   b,h
2F74: 4D          ld   c,l
...
2FBE: CD B3 30    call tile_addr_actor
2FC1: 44          ld   b,h
2FC2: 4D          ld   c,l
...
3204: 00          nop
3205: 00          nop
;;; ==== snake_mgr ($3206) -- snakes A/B: spawn (ldir template) or dispatch snake_ai ====
3206: 00          nop
3207: 00          nop
3208: 00          nop
3209: 21 08 86    ld   hl,snk_init_a
320C: 7E          ld   a,(hl)
320D: A7          and  a
320E: C2 1C 32    jp   nz,$321C
3211: 36 01       ld   (hl),$01
3213: 21 28 86    ld   hl,snkA_wp_lo
3216: 01 15 33    ld   bc,spawn_delay_sa
3219: CD F7 32    call $32F7
321C: 11 00 86    ld   de,snake_ctrl_86
321F: 21 29 86    ld   hl,snkA_wp_hi
3222: 1A          ld   a,(de)
3223: A7          and  a
3224: CC 56 32    call z,$3256
3227: 21 09 86    ld   hl,snk_init_b
322A: 7E          ld   a,(hl)
322B: A7          and  a
322C: C2 3A 32    jp   nz,$323A
322F: 36 01       ld   (hl),$01
3231: 21 48 86    ld   hl,snkB_wp_lo
3234: 01 2B 33    ld   bc,spawn_delay_sb
3237: CD F7 32    call $32F7
323A: 11 02 86    ld   de,snkB_en
323D: 21 49 86    ld   hl,snkB_wp_hi
3240: 1A          ld   a,(de)
3241: A7          and  a
3242: CC 56 32    call z,$3256
3245: 21 00 86    ld   hl,snake_ctrl_86
3248: 7E          ld   a,(hl)
3249: A7          and  a
324A: C4 6D 32    call nz,$326D
324D: 21 02 86    ld   hl,snkB_en
3250: 7E          ld   a,(hl)
3251: A7          and  a
...
3273: 3A 3E 80    ld   a,(endlevel_active)
3276: A7          and  a
3277: C0          ret  nz
3278: 36 01       ld   (hl),$01
327A: 11 10 86    ld   de,snake_rec_a
...
328A: C9          ret
328B: 21 17 86    ld   hl,snkA_state
328E: CD 3F 33    call snake_ai
3291: C9          ret
3292: 00          nop
3293: 00          nop
3294: 00          nop
...
333D: 50          ld   d,b
333E: 00          nop
;;; ==== snake_ai ($333F) -- per-enemy state engine (snakes; twin of cat_ai) ====
333F: 7E          ld   a,(hl)
3340: FE 01       cp   $01
...
335E: C9          ret
335F: 3A 3E 80    ld   a,(endlevel_active)
3362: A7          and  a
3363: C0          ret  nz
3364: EB          ex   de,hl
3365: 42          ld   b,d
...
3435: C9          ret
3436: 2B          dec  hl
3437: 3A 00 80    ld   a,(sprite_mirror)
343A: BE          cp   (hl)
343B: EB          ex   de,hl
...
3928: 00          nop
3929: 00          nop
;;; ==== player_vs_enemy ($392A) -- AABB each enemy vs player; hit -> plr_state=2 ====
392A: 3A 00 B0    ld   a,(dsw)
392D: E6 80       and  $80
392F: C0          ret  nz
3930: 3A 1F 84    ld   a,(plr_state)
3933: FE 01       cp   $01
3935: C0          ret  nz
3936: 3A 3E 80    ld   a,(endlevel_active)
3939: A7          and  a
393A: C0          ret  nz
...
397B: 21 1F 84    ld   hl,plr_state
397E: 36 02       ld   (hl),$02
3980: C9          ret
3981: 3A 01 85    ld   a,(catA_spawn)
3984: A7          and  a
3985: C8          ret  z
3986: 3A 2B 85    ld   a,(catA_busy)
3989: A7          and  a
398A: C0          ret  nz
398B: DD 21 00 80 ld   ix,sprite_mirror
398F: FD 21 04 80 ld   iy,$8004
3993: 11 0E 07    ld   de,$070E
3996: 21 0E 07    ld   hl,$070E
3999: C3 5E 39    jp   $395E
399C: 3A 04 85    ld   a,(catB_en)
399F: A7          and  a
39A0: C8          ret  z
39A1: 3A 6B 85    ld   a,(catB_busy)
39A4: A7          and  a
39A5: C0          ret  nz
39A6: DD 21 00 80 ld   ix,sprite_mirror
39AA: FD 21 0C 80 ld   iy,$800C
39AE: 11 0E 07    ld   de,$070E
39B1: 21 0E 07    ld   hl,$070E
39B4: C3 5E 39    jp   $395E
39B7: 3A 07 85    ld   a,(catC_spawn)
39BA: A7          and  a
39BB: C8          ret  z
39BC: 3A 8B 85    ld   a,(catC_busy)
39BF: A7          and  a
39C0: C0          ret  nz
39C1: DD 21 00 80 ld   ix,sprite_mirror
39C5: FD 21 10 80 ld   iy,$8010
39C9: 11 0E 07    ld   de,$070E
39CC: 21 0E 07    ld   hl,$070E
39CF: C3 5E 39    jp   $395E
39D2: 3A 01 86    ld   a,(snkA_spawn)
39D5: A7          and  a
39D6: C8          ret  z
39D7: 3A 2B 86    ld   a,(snkA_busy)
39DA: A7          and  a
39DB: C0          ret  nz
39DC: DD 21 00 80 ld   ix,sprite_mirror
39E0: FD 21 14 80 ld   iy,$8014
39E4: 11 0A 05    ld   de,$050A
39E7: 21 0A 05    ld   hl,$050A
39EA: C3 5E 39    jp   $395E
39ED: 3A 03 86    ld   a,(snkB_spawn)
39F0: A7          and  a
39F1: C8          ret  z
39F2: 3A 4B 86    ld   a,(snkB_busy)
39F5: A7          and  a
39F6: C0          ret  nz
39F7: DD 21 00 80 ld   ix,sprite_mirror
39FB: FD 21 18 80 ld   iy,$8018
39FF: 11 0A 05    ld   de,$050A
3A02: 21 0A 05    ld   hl,$050A
3A05: C3 5E 39    jp   $395E
3A08: 21 17 85    ld   hl,catA_state
3A0B: 7E          ld   a,(hl)
3A0C: FE 04       cp   $04
3A0E: C0          ret  nz
3A0F: 11 07 80    ld   de,$8007
3A12: C3 2C 3A    jp   $3A2C
3A15: 21 57 85    ld   hl,catB_state
3A18: 7E          ld   a,(hl)
3A19: FE 04       cp   $04
3A1B: C0          ret  nz
3A1C: 11 0F 80    ld   de,$800F
3A1F: C3 2C 3A    jp   $3A2C
3A22: 21 77 85    ld   hl,catC_state
3A25: 7E          ld   a,(hl)
3A26: FE 04       cp   $04
3A28: C0          ret  nz
...
3A4F: C9          ret
3A50: 21 17 86    ld   hl,snkA_state
3A53: 7E          ld   a,(hl)
3A54: FE 04       cp   $04
3A56: C0          ret  nz
3A57: 11 17 80    ld   de,$8017
3A5A: C3 67 3A    jp   $3A67
3A5D: 21 37 86    ld   hl,snkB_state
3A60: 7E          ld   a,(hl)
3A61: FE 04       cp   $04
3A63: C0          ret  nz
...
3A8F: 16 04       ld   d,$04
3A91: 3A 2B 85    ld   a,(catA_busy)
3A94: A7          and  a
3A95: C2 A5 3A    jp   nz,$3AA5
3A98: CD BD 3B    call $3BBD
3A9B: 21 17 85    ld   hl,catA_state
3A9E: 36 06       ld   (hl),$06
3AA0: 21 2B 85    ld   hl,catA_busy
3AA3: 36 01       ld   (hl),$01
3AA5: 3A 6B 85    ld   a,(catB_busy)
3AA8: A7          and  a
3AA9: C2 B9 3A    jp   nz,$3AB9
3AAC: CD BD 3B    call $3BBD
3AAF: 21 57 85    ld   hl,catB_state
3AB2: 36 06       ld   (hl),$06
3AB4: 21 6B 85    ld   hl,catB_busy
3AB7: 36 01       ld   (hl),$01
3AB9: 3A 8B 85    ld   a,(catC_busy)
3ABC: A7          and  a
3ABD: C0          ret  nz
3ABE: CD BD 3B    call $3BBD
3AC1: 21 77 85    ld   hl,catC_state
3AC4: 36 06       ld   (hl),$06
3AC6: 21 8B 85    ld   hl,catC_busy
3AC9: 36 01       ld   (hl),$01
3ACB: C9          ret
;;; ==== event_clear_enemies ($3ACC) -- power-pellet active ($85C0) => clear the board ====
;;; NOT a chase trigger. For each enabled/non-busy enemy (cats $8501/$8505/$8507, snakes
;;; $8601/$8603) write the water-death record: state(+$07)=$04, splash tile(+$04)=$1C/$2C,
;;; busy-lock(+$1B)=$01 (templates $3B26 cats / $3B64 snakes). No overlap test -- all at once.
3ACC: 3A C0 85    ld   a,(event_obj)
3ACF: A7          and  a
3AD0: C8          ret  z
...
3AE0: C9          ret
3AE1: 3A 01 85    ld   a,(catA_spawn)
3AE4: A7          and  a
3AE5: C8          ret  z
3AE6: 3A 2B 85    ld   a,(catA_busy)
3AE9: A7          and  a
3AEA: C0          ret  nz
3AEB: FD 21 04 80 ld   iy,$8004
3AEF: 21 26 3B    ld   hl,$3B26
3AF2: 11 17 85    ld   de,catA_state
3AF5: C3 74 3B    jp   $3B74
3AF8: 3A 05 85    ld   a,(catB_spawn)
3AFB: A7          and  a
3AFC: C8          ret  z
3AFD: 3A 6B 85    ld   a,(catB_busy)
3B00: A7          and  a
3B01: C0          ret  nz
3B02: FD 21 0C 80 ld   iy,$800C
3B06: 21 26 3B    ld   hl,$3B26
3B09: 11 57 85    ld   de,catB_state
3B0C: C3 74 3B    jp   $3B74
3B0F: 3A 07 85    ld   a,(catC_spawn)
3B12: A7          and  a
3B13: C8          ret  z
3B14: 3A 8B 85    ld   a,(catC_busy)
3B17: A7          and  a
3B18: C0          ret  nz
3B19: FD 21 10 80 ld   iy,$8010
3B1D: 21 26 3B    ld   hl,$3B26
3B20: 11 77 85    ld   de,catC_state
...
3B33: 36 04       ld   (hl),$04
3B35: C9          ret
3B36: 3A 01 86    ld   a,(snkA_spawn)
3B39: A7          and  a
3B3A: C8          ret  z
3B3B: 3A 2B 86    ld   a,(snkA_busy)
3B3E: A7          and  a
3B3F: C0          ret  nz
3B40: FD 21 14 80 ld   iy,$8014
3B44: 21 64 3B    ld   hl,$3B64
3B47: 11 17 86    ld   de,snkA_state
3B4A: C3 74 3B    jp   $3B74
3B4D: 3A 03 86    ld   a,(snkB_spawn)
3B50: A7          and  a
3B51: C8          ret  z
3B52: 3A 4B 86    ld   a,(snkB_busy)
3B55: A7          and  a
3B56: C0          ret  nz
3B57: FD 21 18 80 ld   iy,$8018
3B5B: 21 64 3B    ld   hl,$3B64
3B5E: 11 37 86    ld   de,snkB_state
...
3D5D: 3E 00       ld   a,$00
3D5F: 32 22 84    ld   (plr_lock),a
3D62: 3E 01       ld   a,$01
3D64: 32 1F 84    ld   (plr_state),a
3D67: C9          ret
3D68: 23          inc  hl
3D69: 23          inc  hl
3D6A: 23          inc  hl
...
3DA2: C9          ret
3DA3: 3A 06 84    ld   a,(plr_y)
3DA6: D6 08       sub  $08
3DA8: 32 06 84    ld   (plr_y),a
...
3DE8: C9          ret
3DE9: 3A 06 84    ld   a,(plr_y)
3DEC: C6 08       add  a,$08
3DEE: 32 06 84    ld   (plr_y),a
...
3E27: E1          pop  hl
3E28: C9          ret
;;; ==== food_maze_redraw ($3E29) -- repaint maze food from food_state (called at play-build) ====
;;; state 0 -> draw present; state 2 -> reset to 0 and draw (carried food DROPPED back into
;;; the maze on death/respawn); state 1 -> blank (returned food stays gone).
3E29: 21 20 81    ld   hl,food_state
3E2C: DD 21 C6 3F ld   ix,food_pos_tbl
...
;;; ==== food_set_state ($3EB2) -- write reg c into the food_state slot at VRAM cell hl ====
;;; Scans per-maze food_pos_tbl ($3FC6) for the piece whose cell matches hl (also hl+$20,
;;; food is 2x2); on match writes c into $8120[i].  (pickup passes c=2, return c=1)
3EB2: D9          exx
3EB3: 21 20 81    ld   hl,food_state
3EB6: DD 21 C6 3F ld   ix,food_pos_tbl
3EBA: 06 09       ld   b,$09
...
3EF0: D9          exx
3EF1: C9          ret
;;; ==== food_return_add ($3EF2) -- register a food piece carried home ====
;;; Find the first empty ($8140) slot, store the piece id (d=tile, e=color),
;;; draw it to the home display via the $3FB4 ptr table, award 500 pts
;;; (score_add $8040, BCD from $3F31), sound $84.
3EF2: 21 40 81    ld   hl,food_returned
...
3F34: 3E 09       ld   a,$09
;;; ==== food_log_redraw ($3F36) -- repaint all food_returned entries to VRAM ====
3F36: 21 40 81    ld   hl,food_returned
...
3F60: E1          pop  hl
3F61: C9          ret
;;; ==== food_maze_erase ($3F62) -- blank carried (state 2) food cells in the maze ($25/$87) ====
3F62: 21 20 81    ld   hl,food_state
3F65: DD 21 C6 3F ld   ix,food_pos_tbl
...
40B9: ED B0       ldir
40BB: 3A 06 84    ld   a,(plr_y)
40BE: C6 00       add  a,$00
40C0: 32 A5 80    ld   ($80A5),a
40C3: 3A 07 84    ld   a,(plr_x)
40C6: C6 F0       add  a,$F0
...
412D: FE 03       cp   $03
412F: CA 67 41    jp   z,food_return_home
4132: C3 84 40    jp   $4084
4135: 3A 06 84    ld   a,(plr_y)
4138: C6 00       add  a,$00
413A: 32 A5 80    ld   ($80A5),a
413D: 3A 07 84    ld   a,(plr_x)
4140: C6 F0       add  a,$F0
...
;;; ==== food_return_home ($4167) -- mouse reached home carrying a piece ====
;;; Read carried-food block ($809C/$809E/$809F); food_return_add logs it to $8140
;;; (+500 pts); then food_set_state with c=1 flips food_state 2->1 (carried->returned).
4167: 21 9E 80    ld   hl,$809E
416A: 5E          ld   e,(hl)
416B: 23          inc  hl
416C: 56          ld   d,(hl)
416D: CD F2 3E    call food_return_add
4170: 2A 9C 80    ld   hl,($809C)
4173: 0E 01       ld   c,$01
4175: CD B2 3E    call food_set_state
...
41BF: 3A C1 85    ld   a,(event_trig)
41C2: A7          and  a
41C3: C2 D3 41    jp   nz,$41D3
41C6: 32 C0 85    ld   (event_obj),a
41C9: 21 C4 85    ld   hl,event_run
41CC: 06 0C       ld   b,$0C
41CE: 77          ld   (hl),a
41CF: 23          inc  hl
41D0: 10 FC       djnz $41CE
41D2: C9          ret
41D3: 3A C4 85    ld   a,(event_run)
41D6: A7          and  a
41D7: C2 17 42    jp   nz,$4217
41DA: 21 C1 85    ld   hl,event_trig
41DD: 11 C4 85    ld   de,event_run
41E0: 01 03 00    ld   bc,$0003
41E3: ED B0       ldir
41E5: 3E 95       ld   a,$95
41E7: 32 00 B8    ld   (watchdog),a
41EA: 3E 01       ld   a,$01
41EC: 32 C0 85    ld   (event_obj),a
41EF: 3A C5 85    ld   a,(event_y)
41F2: FE 80       cp   $80
...
4217: 3A C6 85    ld   a,(event_x)
421A: FE E0       cp   $E0
421C: D2 27 42    jp   nc,$4227
421F: C6 02       add  a,$02
4221: 32 C6 85    ld   (event_x),a
4224: C3 32 42    jp   $4232
4227: 21 C0 85    ld   hl,event_obj
422A: 06 10       ld   b,$10
422C: 3E 00       ld   a,$00
422E: 77          ld   (hl),a
422F: 23          inc  hl
...
4276: 3A 00 A0    ld   a,(in_joy)
4279: E6 10       and  $10
427B: CA 43 44    jp   z,$4443
427E: 3A 30 80    ld   a,(game_mode)
4281: A7          and  a
...
43F2: 3E 01       ld   a,$01
43F4: 32 32 80    ld   (req_level_done),a
43F7: 3E A0       ld   a,$A0
...
48ED: 24          inc  h
48EE: 24          inc  h
;;; ==== service_check ($48EF) -- per-frame gate (from $3C92/$41BC/$4247) ====
;;; If $A800 & $40 (service/test input) is set, enter the diagnostic text loop
;;; $48FA (never returns); otherwise ret.
48EF: F5          push af
48F0: 3A 00 A8    ld   a,(in_coin)
48F3: E6 40       and  $40
48F5: C2 FA 48    jp   nz,$48FA
48F8: F1          pop  af
48F9: C9          ret
;;; ==== service_text_loop ($48FA) -- diagnostic screen ====
;;; Blit the $491A font/text table to VRAM $9100 (down a column via $490E),
;;; read the watchdog, and loop forever. Reached only via service_check $48EF.
...
;;; ==== text_col_blit ($490E) -- copy b bytes (de)->(hl), stepping VRAM +$20 per row (a column) ====
490E: 1A          ld   a,(de)
490F: 77          ld   (hl),a
4910: 13          inc  de
4911: C5          push bc
...
4919: C9          ret
;;; ==== DATA: font/text table ($491A-$4927, 14 bytes; read by service_text_loop $48FA) ====
491A: 24
491B: 0D
491C: 1D
491D: 15
...
4923: 18 1E
4925: 11 0C 24
;;; ---- end of ROM content ($4928). $4928-$4FFF = $00 padding. ----
