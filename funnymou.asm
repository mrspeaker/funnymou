...
014A  320083  	    ld   (p2_lives_copy),a
014D  C39301  	    jp   start_game
0150  3E05    	    ld   a,$05
0152  320082  	    ld   (lives_copy),a
0155  320083  	    ld   (p2_lives_copy),a
...
0181  3E00    	    ld   a,$00
0183  320083  	    ld   (p2_lives_copy),a
0186  C39301  	    jp   start_game
0189  3E05    	    ld   a,$05
018B  320082  	    ld   (lives_copy),a
018E  3E00    	    ld   a,$00
0190  320083  	    ld   (p2_lives_copy),a
...
02AF  CA9446  	    jp   z,splash_screen_something
...
02E7  CA9123  	    jp   z,game_screen_main_loop
02EA  FE07    	    cp   SCR_GAMBLE
02EC  CA6824  	    jp   z,gamble_screen_loop
02EF  FE08    	    cp   SCR_LUCKY
02F1  CA5645  	    jp   z,very_lucky_mouse_screen
02F4  C9      	    ret
...
03AE  A7      	    and  a
03AF  CAC104  	    jp   z,player_continue
03B2  C38B04  	    jp   player_swap
                _scr_game_1:
03B5  3A3C80  	    ld   a,(is_2player)
03B8  A7      	    and  a
03B9  C21D04  	    jp   nz,die_in_2p_mode
                ;;; 1p mode
03BC  210081  	    ld   hl,lives
03BF  3E00    	    ld   a,$00
03C1  BE      	    cp   (hl)
03C2  CAE903  	    jp   z,game_over
...
0431  110083  	    ld   de,p2_lives_copy
...
044A  A7      	    and  a
044B  C27304  	    jp   nz,p2_swap_continue
...
047D  A7      	    and  a
047E  C2C104  	    jp   nz,player_continue
0481  C38B04  	    jp   player_swap
0484  3A0083  	    ld   a,(p2_lives_copy)
0487  A7      	    and  a
0488  CAC104  	    jp   z,player_continue
...
0522  110083  	    ld   de,p2_lives_copy
...
076A  5F      	    ld   e,a
076B  1600    	    ld   d,$00
076D  DD21D507	    ld   ix,coinage_tbl
0771  DD19    	    add  ix,de
...
079F  C3BC07  	    jp   draw_credits
07A2  FD7E0A  	    ld   a,(iy+$0a)
07A5  A7      	    and  a
07A6  CABC07  	    jp   z,draw_credits
07A9  AF      	    xor  a
...
07D5               db   $02, $01              ; 0: 2 coins -> 1 credit
07D7               db   $01, $01              ; 1: 1 coin  -> 1 credit
07D9               db   $01, $02              ; 2: 1 coin  -> 2 credits
07DB               db   $01, $03              ; 3: 1 coin  -> 3 credits
07DD               db   $01, $04              ; 4: 1 coin  -> 4 credits
07DF               db   $01, $05              ; 5: 1 coin  -> 5 credits
07E1               db   $01, $06              ; 6: 1 coin  -> 6 credits
07E3               db   $01, $07              ; 7: 1 coin  -> 7 credits
07E5  FD360309	    ld   (iy+$03),$09
07E9  AF      	    xor  a
07EA  3202B0  	    ld   (coin_lockout),a
07ED  04      	    inc  b
07EE  C3BC07  	    jp   draw_credits
...
2037  C33D20  	    jp   $203D
203A  210083  	    ld   hl,p2_lives_copy
203D  110081  	    ld   de,lives
2040  01FF00  	    ld   bc,$00FF
2043  EDB0    	    ldir
2045  CD8220  	    call draw_player_text
2048  CD9D20  	    call draw_player_color
204B  CD0B13  	    call draw_cur_level_map
204E  CD293E  	    call food_maze_redraw
2051  CD343F  	    call food_log_redraw_all
2054  CD7B41  	    call draw_boulders
2057  CD2742  	    call boulder_clear
205A  3EA0    	    ld   a,$A0
...
20B6  CD8220  	    call draw_player_text
20B9  CD9D20  	    call draw_player_color
...
2A59  3601    	    ld   (hl),$01
2A5B  212885  	    ld   hl,cat1_spawn_dly
2A5E  015A2B  	    ld   bc,cat1_spawn_dly_tbl
2A61  CDCF31  	    call load_level_ptr
2A64  212D85  	    ld   hl,cat1_speedup_tmr
2A67  01282B  	    ld   bc,cat_speedup_tbl
2A6A  CDCF31  	    call load_level_ptr
2A6D  CD1F2B  	    call cat_ai_init_clear
                ;;
...
2A86  3601    	    ld   (hl),$01
2A88  216885  	    ld   hl,cat2_spawn_dly
2A8B  01B02B  	    ld   bc,cat2_spawn_dly_tbl
2A8E  CDCF31  	    call load_level_ptr
2A91  216D85  	    ld   hl,cat2_speedup_tmr
2A94  01282B  	    ld   bc,cat_speedup_tbl
2A97  CDCF31  	    call load_level_ptr
2A9A  CD1F2B  	    call cat_ai_init_clear
...
2AB3  3601    	    ld   (hl),$01
2AB5  218885  	    ld   hl,cat3_spawn_dly
2AB8  01062C  	    ld   bc,cat3_spawn_dly_tbl
2ABB  CDCF31  	    call load_level_ptr
2ABE  218D85  	    ld   hl,cat3_speedup_tmr
2AC1  01282B  	    ld   bc,cat_speedup_tbl
2AC4  CDCF31  	    call load_level_ptr
2AC7  CD1F2B  	    call cat_ai_init_clear
...
2B28               db   $3C, $78   ; level 0: $783C
2B2A               db   $3C, $64   ; level 1: $643C
2B2C               db   $3C, $5A   ; level 2: $5A3C
2B2E               db   $3C, $46   ; level 3: $463C
2B30               db   $3C, $3C   ; level 4: $3C3C
2B32               db   $3C, $32   ; level 5: $323C
2B34               db   $3C, $28   ; level 6: $283C
2B36               db   $3C, $1E   ; level 7: $1E3C
2B38               db   $3C, $14   ; level 8: $143C
2B3A               db   $3C, $00   ; level 9: $003C
...
2B5A               db   $30, $02   ; level 0: $0230
2B5C               db   $30, $02   ; level 1: $0230
2B5E               db   $30, $02   ; level 2: $0230
2B60               db   $34, $01   ; level 3: $0134
2B62               db   $30, $00   ; level 4: $0030
2B64               db   $30, $00   ; level 5: $0030
2B66               db   $30, $00   ; level 6: $0030
2B68               db   $30, $00   ; level 7: $0030
2B6A               db   $10, $00   ; level 8: $0010
2B6C               db   $10, $00   ; level 9: $0010
...
2BB0               db   $14, $16   ; level 0: $1614
2BB2               db   $14, $14   ; level 1: $1414
2BB4               db   $14, $0F   ; level 2: $0F14
2BB6               db   $14, $0D   ; level 3: $0D14
2BB8               db   $00, $0B   ; level 4: $0B00
2BBA               db   $00, $09   ; level 5: $0900
2BBC               db   $18, $06   ; level 6: $0618
2BBE               db   $28, $05   ; level 7: $0528
2BC0               db   $28, $05   ; level 8: $0528
2BC2               db   $10, $04   ; level 9: $0410
...
2C06               db   $24, $06   ; level 0: $0624
2C08               db   $24, $06   ; level 1: $0624
2C0A               db   $14, $02   ; level 2: $0214
2C0C               db   $00, $02   ; level 3: $0200
2C0E               db   $30, $00   ; level 4: $0030
2C10               db   $30, $00   ; level 5: $0030
2C12               db   $30, $00   ; level 6: $0030
2C14               db   $30, $00   ; level 7: $0030
2C16               db   $10, $00   ; level 8: $0010
2C18               db   $10, $00   ; level 9: $0010
...
3222  1A      	    ld   a,(de)
3223  A7      	    and  a
3224  CC5632  	    call z,snake_spawn_gate
...
3240  1A      	    ld   a,(de)
3241  A7      	    and  a
3242  CC5632  	    call z,snake_spawn_gate
...
337D  CDB337  	    call enemy_sprite_commit_b
3380  C9      	    ret
3381  062F    	    ld   b,$2F
...
338A  3E03    	    ld   a,$03
338C  02      	    ld   (bc),a
338D  CDB337  	    call enemy_sprite_commit_b
3390  C9      	    ret
3391  1A      	    ld   a,(de)
...
33CE  3E22    	    ld   a,$22
33D0  BE      	    cp   (hl)
33D1  CA4B34  	    jp   z,snake_drift_gate
33D4  C620    	    add  a,$20
33D6  10F8    	    djnz $33D0
33D8  C39934  	    jp   $3499
33DB  ED5F    	    ld   a,r
...
345F  E603    	    and  $03
3461  FE00    	    cp   $00
3463  C4FD33  	    call nz,snake_chase
3466  EB      	    ex   de,hl
...
3485  E603    	    and  $03
3487  FE02    	    cp   $02
3489  C4FD33  	    call nz,snake_chase
348C  EB      	    ex   de,hl
...
349E  E607    	    and  $07
34A0  FE04    	    cp   $04
34A2  C21037  	    jp   nz,snake_move_midcell
34A5  7E      	    ld   a,(hl)
34A6  E607    	    and  $07
34A8  FE02    	    cp   $02
34AA  C21037  	    jp   nz,snake_move_midcell
34AD  EB      	    ex   de,hl
34AE  CDCA37  	    call get_tile_pos_b
...
34DD  7E      	    ld   a,(hl)
34DE  0F      	    rrca
34DF  DA9F35  	    jp   c,snake_mover_xm
34E2  0F      	    rrca
34E3  DAFA35  	    jp   c,snake_mover_xp
34E6  0F      	    rrca
34E7  DA5536  	    jp   c,snake_mover_yp
34EA  0F      	    rrca
34EB  DAB236  	    jp   c,snake_mover_ym
...
34FC  23      	    inc  hl
34FD  77      	    ld   (hl),a
34FE  C37437  	    jp   snake_move_apply
...
352B  3601    	    ld   (hl),$01
352D  C3EE34  	    jp   snake_halt
3530  3602    	    ld   (hl),$02
3532  C3EE34  	    jp   snake_halt
3535  EB      	    ex   de,hl
3536  3604    	    ld   (hl),$04
3538  C3EE34  	    jp   snake_halt
353B  EB      	    ex   de,hl
353C  3608    	    ld   (hl),$08
353E  C3EE34  	    jp   snake_halt
...
3576  3604    	    ld   (hl),$04
3578  C3EE34  	    jp   snake_halt
357B  3608    	    ld   (hl),$08
357D  C3EE34  	    jp   snake_halt
3580  EB      	    ex   de,hl
3581  3602    	    ld   (hl),$02
3583  C3EE34  	    jp   snake_halt
3586  EB      	    ex   de,hl
3587  3601    	    ld   (hl),$01
3589  C3EE34  	    jp   snake_halt
...
35A3  1A      	    ld   a,(de)
35A4  FE0C    	    cp   $0C
35A6  CAEE34  	    jp   z,snake_halt
35A9  D2B235  	    jp   nc,$35B2
35AC  3E0C    	    ld   a,$0C
35AE  12      	    ld   (de),a
35AF  C3EE34  	    jp   snake_halt
35B2  13      	    inc  de
35B3  CDCA37  	    call get_tile_pos_b
35B6  44      	    ld   b,h
35B7  4D      	    ld   c,l
...
35BC  3EDF    	    ld   a,$DF
35BE  BE      	    cp   (hl)
35BF  D20135  	    jp   nc,snake_blocked
35C2  210B00  	    ld   hl,$000B
35C5  19      	    add  hl,de
35C6  EB      	    ex   de,hl
35C7  21E2FF  	    ld   hl,$FFE2
35CA  CDE537  	    call snake_food_probeA
35CD  A7      	    and  a
35CE  C2D735  	    jp   nz,$35D7
35D1  210200  	    ld   hl,$0002
35D4  CDE537  	    call snake_food_probeA
35D7  13      	    inc  de
35D8  13      	    inc  de
35D9  21E2FF  	    ld   hl,$FFE2
35DC  CD0C38  	    call snake_food_probeB
35DF  A7      	    and  a
35E0  C2E935  	    jp   nz,$35E9
35E3  210200  	    ld   hl,$0002
35E6  CD0C38  	    call snake_food_probeB
...
35F5  13      	    inc  de
35F6  12      	    ld   (de),a
35F7  C32237  	    jp   snake_step_reset
...
35FE  1A      	    ld   a,(de)
35FF  FEE4    	    cp   $E4
3601  CAEE34  	    jp   z,snake_halt
3604  DA0D36  	    jp   c,$360D
3607  3EE4    	    ld   a,$E4
3609  12      	    ld   (de),a
360A  C3EE34  	    jp   snake_halt
360D  13      	    inc  de
360E  CDCA37  	    call get_tile_pos_b
3611  44      	    ld   b,h
3612  4D      	    ld   c,l
...
3617  3EDF    	    ld   a,$DF
3619  BE      	    cp   (hl)
361A  D20135  	    jp   nc,snake_blocked
361D  210B00  	    ld   hl,$000B
3620  19      	    add  hl,de
3621  EB      	    ex   de,hl
3622  21E2FF  	    ld   hl,$FFE2
3625  CDE537  	    call snake_food_probeA
3628  A7      	    and  a
3629  C23236  	    jp   nz,$3632
362C  21C2FF  	    ld   hl,$FFC2
362F  CDE537  	    call snake_food_probeA
3632  13      	    inc  de
3633  13      	    inc  de
3634  21E2FF  	    ld   hl,$FFE2
3637  CD0C38  	    call snake_food_probeB
363A  A7      	    and  a
363B  C24436  	    jp   nz,$3644
363E  21C2FF  	    ld   hl,$FFC2
3641  CD0C38  	    call snake_food_probeB
...
3650  13      	    inc  de
3651  12      	    ld   (de),a
3652  C32237  	    jp   snake_step_reset
...
365A  1A      	    ld   a,(de)
365B  FEEC    	    cp   $EC
365D  CAEE34  	    jp   z,snake_halt
3660  DA6936  	    jp   c,$3669
3663  3EEC    	    ld   a,$EC
3665  12      	    ld   (de),a
3666  C3EE34  	    jp   snake_halt
3669  CDCA37  	    call get_tile_pos_b
366C  44      	    ld   b,h
366D  4D      	    ld   c,l
...
3672  3EDF    	    ld   a,$DF
3674  BE      	    cp   (hl)
3675  D20135  	    jp   nc,snake_blocked
3678  210B00  	    ld   hl,$000B
367B  19      	    add  hl,de
367C  EB      	    ex   de,hl
367D  21E2FF  	    ld   hl,$FFE2
3680  CDE537  	    call snake_food_probeA
3683  A7      	    and  a
3684  C28D36  	    jp   nz,$368D
3687  21E3FF  	    ld   hl,$FFE3
368A  CDE537  	    call snake_food_probeA
368D  13      	    inc  de
368E  13      	    inc  de
368F  21E2FF  	    ld   hl,$FFE2
3692  CD0C38  	    call snake_food_probeB
3695  A7      	    and  a
3696  C29F36  	    jp   nz,$369F
3699  21E3FF  	    ld   hl,$FFE3
369C  CD0C38  	    call snake_food_probeB
...
36AD  77      	    ld   (hl),a
36AE  EB      	    ex   de,hl
36AF  C32237  	    jp   snake_step_reset
...
36B7  1A      	    ld   a,(de)
36B8  FE14    	    cp   $14
36BA  CAEE34  	    jp   z,snake_halt
36BD  D2C636  	    jp   nc,$36C6
36C0  3E14    	    ld   a,$14
36C2  12      	    ld   (de),a
36C3  C3EE34  	    jp   snake_halt
36C6  CDCA37  	    call get_tile_pos_b
36C9  44      	    ld   b,h
36CA  4D      	    ld   c,l
...
36CF  3EDF    	    ld   a,$DF
36D1  BE      	    cp   (hl)
36D2  D20135  	    jp   nc,snake_blocked
36D5  210B00  	    ld   hl,$000B
36D8  19      	    add  hl,de
36D9  EB      	    ex   de,hl
36DA  21E2FF  	    ld   hl,$FFE2
36DD  CDE537  	    call snake_food_probeA
36E0  A7      	    and  a
36E1  C2EA36  	    jp   nz,$36EA
36E4  21E1FF  	    ld   hl,$FFE1
36E7  CDE537  	    call snake_food_probeA
36EA  13      	    inc  de
36EB  13      	    inc  de
36EC  21E2FF  	    ld   hl,$FFE2
36EF  CD0C38  	    call snake_food_probeB
36F2  A7      	    and  a
36F3  C2FC36  	    jp   nz,$36FC
36F6  21E1FF  	    ld   hl,$FFE1
36F9  CD0C38  	    call snake_food_probeB
...
370B  77      	    ld   (hl),a
370C  EB      	    ex   de,hl
370D  C32237  	    jp   snake_step_reset
...
371E  19      	    add  hl,de
371F  C33037  	    jp   snake_speed_tiers
...
373C  12      	    ld   (de),a
373D  FE01    	    cp   $01
373F  CA7437  	    jp   z,snake_move_apply
3742  C36837  	    jp   snake_move_skip
3745  13      	    inc  de
3746  13      	    inc  de
3747  1A      	    ld   a,(de)
3748  A7      	    and  a
...
3750  02      	    ld   (bc),a
3751  FE01    	    cp   $01
3753  CA7437  	    jp   z,snake_move_apply
3756  C36837  	    jp   snake_move_skip
3759  0A      	    ld   a,(bc)
375A  3C      	    inc  a
375B  E607    	    and  $07
375D  02      	    ld   (bc),a
375E  FE03    	    cp   $03
3760  CA6837  	    jp   z,snake_move_skip
3763  FE05    	    cp   $05
3765  C27437  	    jp   nz,snake_move_apply
...
3798  2B      	    dec  hl
3799  1B      	    dec  de
379A  CDA137  	    call enemy_anim_frame
379D  CDB337  	    call enemy_sprite_commit_b
37A0  C9      	    ret
...
3854  19      	    add  hl,de
3855  EB      	    ex   de,hl
3856  CDB337  	    call enemy_sprite_commit_b
3859  C9      	    ret
385A  EB      	    ex   de,hl
...
3888  EB      	    ex   de,hl
3889  1B      	    dec  de
388A  CDB337  	    call enemy_sprite_commit_b
388D  C9      	    ret
388E  EB      	    ex   de,hl
...
38BC  EB      	    ex   de,hl
38BD  1B      	    dec  de
38BE  CDB337  	    call enemy_sprite_commit_b
38C1  C9      	    ret
38C2  0E00    	    ld   c,$00
38C4  23      	    inc  hl
38C5  71      	    ld   (hl),c
...
38FA  19      	    add  hl,de
38FB  EB      	    ex   de,hl
38FC  011039  	    ld   bc,snake_lvl_param_tbl
38FF  211500  	    ld   hl,$0015
3902  19      	    add  hl,de
3903  CDF732  	    call snake_spawn_delay
3906  CDB337  	    call enemy_sprite_commit_b
3909  C9      	    ret
...
3910               db   $70, $02   ; level 0: $0270
3912               db   $70, $01   ; level 1: $0170
3914               db   $F0, $00   ; level 2: $00F0
3916               db   $F0, $00   ; level 3: $00F0
3918               db   $F0, $00   ; level 4: $00F0
391A               db   $F0, $00   ; level 5: $00F0
391C               db   $F0, $00   ; level 6: $00F0
391E               db   $F0, $00   ; level 7: $00F0
3920               db   $F0, $00   ; level 8: $00F0
3922               db   $F0, $00   ; level 9: $00F0
3924               db   $00, $00, $00, $00, $00, $00 ; padding (index clamps to level 9)
...
3A32  CD993B  	    call get_tile_at_sprite
3A35  FE37    	    cp   $37
3A37  C0      	    ret  nz
3A38  3605    	    ld   (hl),$05
3A3A  3E96    	    ld   a,$96
...
3A6D  CD993B  	    call get_tile_at_sprite
3A70  FE37    	    cp   $37
3A72  C0      	    ret  nz
3A73  3605    	    ld   (hl),$05
3A75  C3853A  	    jp   $3A85
...
421A  FEE0    	    cp   $E0
421C  D22742  	    jp   nc,boulder_clear
421F  C602    	    add  a,$02
...
4276  3A00A0  	    ld   a,(hw_in_0)       ; gamble: read player input
4279  E610    	    and  $10              ; isolate shot button (button1)
427B  CA4344  	    jp   z,$4443          ; not pressed -> keep reels spinning
...
471E  4F      	    ld   c,a
471F  0600    	    ld   b,$00
4721  21E347  	    ld   hl,gamble_win_pic
4724  09      	    add  hl,bc
4725  5E      	    ld   e,(hl)
4726  23      	    inc  hl
4727  56      	    ld   d,(hl)
...
4791  3602    	    ld   (hl),$02
4793  C9      	    ret
4794  218B48  	    ld   hl,insert_coin_hdr
4797  CDC947  	    call $47C9
479A  C9      	    ret
479B  21A348  	    ld   hl,coin_play_hdr
479E  CDC947  	    call $47C9
47A1  DD21D507	    ld   ix,coinage_tbl
...
47BA  C9      	    ret
47BB  21BB48  	    ld   hl,coin_blank_hdr
47BE  CDC947  	    call $47C9
47C1  C9      	    ret
47C2  21D348  	    ld   hl,copyright_hdr
...
47E3               db   $26, $93, $24, $F5   ; VRAM $9326 tile $24
47E7               db   $06, $93, $D9, $F5   ; VRAM $9306 tile $D9
47EB               db   $E6, $92, $D7, $F5   ; VRAM $92E6 tile $D7
47EF               db   $C6, $92, $D5, $F5   ; VRAM $92C6 tile $D5
47F3               db   $A6, $92, $D3, $F5   ; VRAM $92A6 tile $D3
47F7               db   $86, $92, $D1, $F5   ; VRAM $9286 tile $D1
47FB               db   $66, $92, $CF, $F5   ; VRAM $9266 tile $CF
47FF               db   $46, $92, $CD, $F5   ; VRAM $9246 tile $CD
4803               db   $26, $92, $CB, $F5   ; VRAM $9226 tile $CB
4807               db   $06, $92, $C9, $F5   ; VRAM $9206 tile $C9
480B               db   $E6, $91, $C7, $F5   ; VRAM $91E6 tile $C7
480F               db   $C6, $91, $C5, $F5   ; VRAM $91C6 tile $C5
4813               db   $A6, $91, $C3, $F5   ; VRAM $91A6 tile $C3
4817               db   $86, $91, $C1, $F5   ; VRAM $9186 tile $C1
481B               db   $66, $91, $BF, $F5   ; VRAM $9166 tile $BF
481F               db   $46, $91, $BD, $F5   ; VRAM $9146 tile $BD
4823               db   $26, $91, $BB, $F5   ; VRAM $9126 tile $BB
4827               db   $06, $91, $B9, $F5   ; VRAM $9106 tile $B9
482B               db   $E6, $90, $B7, $F5   ; VRAM $90E6 tile $B7
482F               db   $C6, $90, $B5, $F5   ; VRAM $90C6 tile $B5
4833               db   $A6, $90, $B3, $F5   ; VRAM $90A6 tile $B3
4837               db   $27, $93, $24, $F5   ; VRAM $9327 tile $24
483B               db   $07, $93, $DA, $F5   ; VRAM $9307 tile $DA
483F               db   $E7, $92, $D8, $F5   ; VRAM $92E7 tile $D8
4843               db   $C7, $92, $D6, $F5   ; VRAM $92C7 tile $D6
4847               db   $A7, $92, $D4, $F5   ; VRAM $92A7 tile $D4
484B               db   $87, $92, $D2, $F5   ; VRAM $9287 tile $D2
484F               db   $67, $92, $D0, $F5   ; VRAM $9267 tile $D0
4853               db   $47, $92, $CE, $F5   ; VRAM $9247 tile $CE
4857               db   $27, $92, $CC, $F5   ; VRAM $9227 tile $CC
485B               db   $07, $92, $CA, $F5   ; VRAM $9207 tile $CA
485F               db   $E7, $91, $C8, $F5   ; VRAM $91E7 tile $C8
4863               db   $C7, $91, $C6, $F5   ; VRAM $91C7 tile $C6
4867               db   $A7, $91, $C4, $F5   ; VRAM $91A7 tile $C4
486B               db   $87, $91, $C2, $F5   ; VRAM $9187 tile $C2
486F               db   $67, $91, $C0, $F5   ; VRAM $9167 tile $C0
4873               db   $47, $91, $BE, $F5   ; VRAM $9147 tile $BE
4877               db   $27, $91, $BC, $F5   ; VRAM $9127 tile $BC
487B               db   $07, $91, $BA, $F5   ; VRAM $9107 tile $BA
487F               db   $E7, $90, $B8, $F5   ; VRAM $90E7 tile $B8
4883               db   $C7, $90, $B6, $F5   ; VRAM $90C7 tile $B6
4887               db   $A7, $90, $B4, $F5   ; VRAM $90A7 tile $B4
                insert_coin_hdr:    ; draw-descriptor for coin_copyright_table text: [VRAM_dest_LE $9336, count $14, color $86]; drawn by $47C9
488B               db   $36, $93, $14, $86   ; -> VRAM $9336, 20 chars, color $86
